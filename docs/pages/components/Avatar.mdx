...
| color-bg-Avatar | $color-surface-100 | $color-surface-800 |
| color-border-Avatar | $color-surface-400A80 | $color-surface-700 |
| color-text-Avatar | $color-text-secondary | $color-text-secondary |
| font-weight-Avatar | $font-weight-bold | $font-weight-bold |
| radius-Avatar | 4px | 4px |
| shadow-Avatar | inset 0 0 0 1px rgba(4,32,69,0.1) | inset 0 0 0 1px rgba(4,32,69,0.1) |
| style-border-Avatar | solid | solid |
| thickness-border-Avatar | 0px | 0px |
