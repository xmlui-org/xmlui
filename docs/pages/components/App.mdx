...
### `defaultTheme (optional, default: xmlui)`

This property sets the app's default theme.

### `defaultTone (optional, default: light)`
...
### `noScrollbarGutters (optional, default: false)`

This boolean property specifies whether the scrollbar gutters should be hidden.

### `scrollWholePage (optional, default: true)`
...
| --- | --- | --- |
| [border-bottom](../styles-and-themes/common-units/#border)-AppHeader | <GrayText>none</GrayText> | <GrayText>none</GrayText> |
| [color-bg](../styles-and-themes/common-units/#color)-AppHeader | <GrayText>none</GrayText> | <GrayText>none</GrayText> |
| [max-content-width](../styles-and-themes/common-units/#size)-App | $max-content-width | $max-content-width |
| [shadow](../styles-and-themes/common-units/#color)-header-App | $shadow-spread | $shadow-spread |
| [shadow](../styles-and-themes/common-units/#color)-pages-App | $shadow-spread | $shadow-spread |
