...
- `boxShadow‑header‑App`: This variable sets the [boxShadow](./appearance/common-units/#boxShadow-values) to display around the app's header.
- `boxShadow‑Pages‑App`: This variable sets the style of [boxShadow](./appearance/common-units/#boxShadow-values) to display around the app's navigation panel (menu).
...
| [boxShadow](../styles-and-themes/common-units/#boxShadow)-header-App | $shadow-spread | $shadow-spread |
| [boxShadow](../styles-and-themes/common-units/#boxShadow)-pages-App | $shadow-spread | $shadow-spread |
