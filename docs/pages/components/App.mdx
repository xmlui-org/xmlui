...
import Test from "../../component-samples/App/test.xmlui";
...
<Playground previewOnly={false} name="Example: 'horizontal' layout" height={350} app={horizontal} components={[Test]}/>
