...
- `backgroundColor-AppHeader`: sets the background color of the header
- `padding` (including all `padding` variants, such as `paddingLeft` and others)
- `borderColor` (including all `borderColor` variants, such as `borderLeftColor` and others)
- `borderStyle` (including all `borderStyle` variants, such as `borderLeftStyle` and others)
- `borderWidth` (including all `borderWidth` variants, such as `borderLeftWidth` and others)
...
| [backgroundColor](../styles-and-themes/common-units/#color)-AppHeader | white | $color-surface-900 |
