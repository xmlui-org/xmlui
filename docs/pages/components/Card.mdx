...
| padding-Card | $padding-vertical-Card $padding-horizontal-Card | $padding-vertical-Card $padding-horizontal-Card |
| padding-horizontal-Card | $space-4 | $space-4 |
| padding-vertical-Card | $space-4 | $space-4 |
...
| [thickness](../styles-and-themes/common-units/#size-values)-border-Card | 1px | 1px |
