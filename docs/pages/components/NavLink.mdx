...
| color-bg-NavLink--active |  |  |
| color-bg-NavLink--hover |  |  |
| color-bg-NavLink--hover--active |  |  |
| color-bg-NavLink--pressed |  |  |
| color-bg-NavLink--pressed--active |  |  |
| color-icon-NavLink | $color-surface-500 |  |
| color-indicator-NavLink |  |  |
...
| color-text-NavLink--active |  |  |
| color-text-NavLink--hover |  |  |
| color-text-NavLink--hover--active |  |  |
| color-text-NavLink--pressed |  |  |
| color-text-NavLink--pressed--active |  |  |
