...
| --- | --- | --- |
| color-bg-NavLink | transparent | transparent |
| color-bg-NavLink--active | (fallback) | (fallback) |
| color-bg-NavLink--hover | (fallback) | (fallback) |
| color-bg-NavLink--hover--active | (fallback) | (fallback) |
| color-bg-NavLink--pressed | (fallback) | (fallback) |
| color-bg-NavLink--pressed--active | (fallback) | (fallback) |
| color-icon-NavLink | $color-surface-500 | (fallback) |
| color-indicator-NavLink | (fallback) | (fallback) |
| color-indicator-NavLink--active | $color-primary-500 | $color-primary-500 |
| color-indicator-NavLink--hover | $color-primary-600 | $color-primary-400 |
| color-indicator-NavLink--pressed | $color-primary-500 | $color-primary-500 |
| color-outline-NavLink--focus | $color-outline--focus | $color-outline--focus |
| color-text-NavLink | $color-text-primary | $color-text-primary |
| color-text-NavLink--active | (fallback) | (fallback) |
| color-text-NavLink--hover | (fallback) | (fallback) |
| color-text-NavLink--hover--active | (fallback) | (fallback) |
| color-text-NavLink--pressed | (fallback) | (fallback) |
| color-text-NavLink--pressed--active | (fallback) | (fallback) |
| font-family-NavLink | $font-family | $font-family |
| font-size-NavLink | $font-size-small | $font-size-small |
| font-weight-NavLink | $font-weight-normal | $font-weight-normal |
| font-weight-NavLink--active | (fallback) | (fallback) |
| font-weight-NavLink--pressed | $font-weight-normal | $font-weight-normal |
...
| thickness-outline-NavLink--focus | $thickness-outline--focus | $thickness-outline--focus |
