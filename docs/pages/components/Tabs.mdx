...
| --- | --- | --- |
| color-bg-Tabs | $color-bg-primary | $color-bg-primary |
| color-bg-trigger-Tabs | $color-bg-primary | $color-bg-primary |
| color-bg-trigger-Tabs--hover | $color-primary-50 | $color-primary-800 |
| color-border-Tabs | $color-border | $color-border |
| color-border-active-Tabs | $color-primary | $color-primary |
| style-border-Tabs | solid | solid |
| thickness-border-Tabs | 2px | 2px |
