...
| --- | --- | --- |
| [color-bg](../styles-and-themes/common-units/#color-values)-ProgressBar | $color-surface-200 | $color-surface-700 |
| [color](../styles-and-themes/common-units/#color-values)-indicator-ProgressBar | $color-primary-500 | $color-primary-500 |
...
| [thickness](../styles-and-themes/common-units/#size-values)-ProgressBar | $space-2 | $space-2 |
