...
| color-bg-Splitter | (fallback) | (fallback) |
| color-bg-resizer-Splitter | $color-bg-Card | $color-bg-Card |
| color-border-Splitter | (fallback) | (fallback) |
...
| style-border-Splitter | (fallback) | (fallback) |
| thickness-border-Splitter | (fallback) | (fallback) |
