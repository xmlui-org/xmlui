...
| padding-Splitter | (fallback) | (fallback) |
| radius-Splitter | (fallback) | (fallback) |
| shadow-Splitter | (fallback) | (fallback) |
| [style-border](../styles-and-themes/common-units/#border-style-values)-Splitter | (fallback) | (fallback) |
| [thickness](../styles-and-themes/common-units/#size-values)-border-Splitter | (fallback) | (fallback) |
