...
| --- | --- | --- |
| border-Splitter | (fallback) | (fallback) |
| [color-bg](../styles-and-themes/common-units/#color-values)-Splitter | (fallback) | (fallback) |
| [color-bg](../styles-and-themes/common-units/#color-values)-resizer-Splitter | $color-bg-Card | $color-bg-Card |
| [color-border](../styles-and-themes/common-units/#color-values)-Splitter | (fallback) | (fallback) |
...
| [padding](../styles-and-themes/common-units/#size-values)-Splitter | (fallback) | (fallback) |
| [radius](../styles-and-themes/common-units/#border-rounding)-Splitter | (fallback) | (fallback) |
| [shadow](../styles-and-themes/common-units/#color-values)-Splitter | (fallback) | (fallback) |
| [style-border](../styles-and-themes/common-units/#border-style-values)-Splitter | (fallback) | (fallback) |
| [thickness-border](../styles-and-themes/common-units/#size-values)-Splitter | (fallback) | (fallback) |
