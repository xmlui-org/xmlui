...
### `borderCollapse (optional, default: true)`
...
### `groupsInitiallyExpanded (optional)`
...
### `hideEmptyGroups (optional, default: true)`
...
### `scrollAnchor (optional, default: top)`
