...
This property adds default groups for the `List` and displays the group headers in the specified order. If a group header is declared here, that is displayed even if no items fall into a particular section.
