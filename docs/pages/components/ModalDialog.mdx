...
| --- | --- | --- |
| color-bg-ModalDialog | $color-bg-primary | $color-bg-primary |
| color-bg-overlay-ModalDialog | $color-bg-overlay | $color-bg-overlay |
| color-text-ModalDialog | $color-text-primary | $color-text-primary |
| font-family-ModalDialog | $font-family | $font-family |
| margin-bottom-title-ModalDialog | 0 | 0 |
| max-width-ModalDialog | 450px | 450px |
| min-width-ModalDialog | (fallback) | (fallback) |
| radius-ModalDialog | $radius | $radius |
| color-bg-ModalDialog | $color-bg-primary | $color-bg-primary |
| color-bg-overlay-ModalDialog | $color-bg-overlay | $color-bg-overlay |
| color-text-ModalDialog | $color-text-primary | $color-text-primary |
| font-family-ModalDialog | $font-family | $font-family |
...
| padding-bottom-ModalDialog | $padding-vertical-ModalDialog | $padding-vertical-ModalDialog |
| padding-bottom-overlay-ModalDialog | (fallback) | (fallback) |
| padding-horizontal-ModalDialog |  |  |
| padding-horizontal-overlay-ModalDialog | (fallback) | (fallback) |
| padding-left-ModalDialog | $padding-horizontal-ModalDialog | $padding-horizontal-ModalDialog |
| padding-left-overlay-ModalDialog | (fallback) | (fallback) |
| padding-overlay-ModalDialog | (fallback) | (fallback) |
| padding-right-ModalDialog | $padding-horizontal-ModalDialog | $padding-horizontal-ModalDialog |
| padding-right-overlay-ModalDialog | (fallback) | (fallback) |
| padding-top-ModalDialog | $padding-vertical-ModalDialog | $padding-vertical-ModalDialog |
| padding-top-overlay-ModalDialog | (fallback) | (fallback) |
| padding-vertical-ModalDialog |  |  |
| padding-vertical-overlay-ModalDialog | (fallback) | (fallback) |
| radius-ModalDialog | $radius | $radius |
