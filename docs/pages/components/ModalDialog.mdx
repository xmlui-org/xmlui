...
| [color](../styles-and-themes/common-units/#color-values)-text-ModalDialog | $color-text-primary | $color-text-primary |
...
| min-[width](../styles-and-themes/common-units/#size-values)-ModalDialog | (fallback) | (fallback) |
