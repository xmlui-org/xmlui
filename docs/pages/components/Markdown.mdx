...
`Markdown` displays plain text styled with markdown syntax.
...
Optional URL to load the markdown content from.

### `value`

Bound data value, typically populated by a DataSource.
