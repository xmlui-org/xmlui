...
| --- | --- | --- |
| [color-bg](../styles-and-themes/common-units/#color)-Badge | $color-primary-500 | $color-primary-500 |
| [color-text](../styles-and-themes/common-units/#color)-Badge | $color-surface-50 | $color-surface-50 |
