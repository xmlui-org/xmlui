...
| [padding-horizontal](../styles-and-themes/common-units/#size-values)-Badge-pill | (fallback) | (fallback) |
| [padding-vertical](../styles-and-themes/common-units/#size-values)-Badge | $space-0_5 | $space-0_5 |
| [padding-vertical](../styles-and-themes/common-units/#size-values)-Badge-pill | (fallback) | (fallback) |
