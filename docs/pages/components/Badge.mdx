...
| [color](../styles-and-themes/common-units/#color-values)-text-Badge | $color-surface-50 | $color-surface-50 |
...
| padding-Badge | $padding-vertical-Badge $padding-horizontal-Badge | $padding-vertical-Badge $padding-horizontal-Badge |
| padding-Badge-pill | $padding-vertical-Badge-pill $padding-horizontal-Badge-pill | $padding-vertical-Badge-pill $padding-horizontal-Badge-pill |
| padding-horizontal-Badge | $space-2 | $space-2 |
| padding-horizontal-Badge-pill | (fallback) | (fallback) |
| padding-vertical-Badge | $space-0_5 | $space-0_5 |
| padding-vertical-Badge-pill | (fallback) | (fallback) |
| radius-Badge | 4px | 4px |
