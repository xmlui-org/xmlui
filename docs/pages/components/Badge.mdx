...
| --- | --- | --- |
| color-bg-Badge | $color-primary-500 | $color-primary-500 |
| color-text-Badge | $color-surface-50 | $color-surface-50 |
| font-size-Badge | $font-size-normal | $font-size-normal |
| font-size-Badge-pill | $font-size-normal | $font-size-normal |
| font-weight-Badge | $font-weight-bold | $font-weight-bold |
| font-weight-Badge-pill | $font-weight-normal | $font-weight-normal |
