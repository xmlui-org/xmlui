...
| --- | --- | --- |
| ccolor-text-Link--active | (fallback) | $color-primary-500 |
| color-decoration-Link | $color-surface-400 | $color-surface-400 |
| color-outline-Link--focus | $color-outline--focus | $color-outline--focus |
| color-text-Link | $color-primary-500 | $color-primary-500 |
| color-text-Link--active | $color-primary-500 | (fallback) |
| color-text-Link--hover | (fallback) | (fallback) |
| color-text-Link--hover--active | $color-text-Link--active | $color-text-Link--active |
| color-text-decoration-Link--active | $color-surface200 | $color-surface200 |
| color-text-decoration-Link--hover | $color-surface-400A80 | $color-surface-400A80 |
| font-weight-HyperLink | (fallback) | (fallback) |
| font-weight-Link--active | $font-weight-bold | $font-weight-bold |
...
| thickness-decoration-Link | $space-0_5 | $space-0_5 |
| thickness-outline-Link--focus | $thickness-outline--focus | $thickness-outline--focus |
