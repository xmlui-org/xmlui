...
| --- | --- | --- |
| color-MenuItem | $color-text-primary | $color-text-primary |
| color-MenuItem--active | $color-primary | $color-primary |
| color-MenuItem--active--hover | (fallback) | (fallback) |
| color-MenuItem--hover | inherit | inherit |
| color-MenuSeparator | (fallback) | (fallback) |
| color-bg-DropdownMenu | (fallback) | (fallback) |
| color-bg-MenuItem | $color-bg-dropdown-item | $color-bg-dropdown-item |
| color-bg-MenuItem--active | $color-bg-dropdown-item--active | $color-bg-dropdown-item--active |
| color-bg-MenuItem--active--hover | (fallback) | (fallback) |
| color-bg-MenuItem--hover | $color-bg-dropdown-item--hover | $color-bg-dropdown-item--hover |
| color-border-DropdownMenu-content | (fallback) | (fallback) |
| font-family-MenuItem | $font-family | $font-family |
| font-size-MenuItem | $font-size-small | $font-size-small |
| gap-MenuItem | $space-2 | $space-2 |
| height-MenuSeparator | (fallback) | (fallback) |
| margin-bottom-MenuSeparator | (fallback) | (fallback) |
| margin-top-MenuSeparator | (fallback) | (fallback) |
| min-width-DropdownMenu | (fallback) | (fallback) |
...
| style-border-DropdownMenu-content | (fallback) | (fallback) |
| thickness-border-DropdownMenu-content | (fallback) | (fallback) |
| width-MenuSeparator | (fallback) | (fallback) |
