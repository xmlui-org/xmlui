...
| --- | --- | --- |
| [color](../styles-and-themes/common-units/#color-values)-text-FormItemLabel | $color-text-primary | $color-text-primary |
| [color](../styles-and-themes/common-units/#color-values)-text-FormItemLabel-required | (fallback) | (fallback) |
| [color](../styles-and-themes/common-units/#color-values)-text-FormItemLabel-requiredMark | $color-danger-400 | $color-danger-400 |
