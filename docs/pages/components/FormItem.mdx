...
| --- | --- | --- |
| color-text-FormItemLabel | $color-text-primary | $color-text-primary |
| color-text-FormItemLabel-required | (fallback) | (fallback) |
| color-text-FormItemLabel-requiredMark | $color-danger-400 | $color-danger-400 |
| font-size-FormItemLabel | $font-size-small | $font-size-small |
| font-size-FormItemLabel-required | (fallback) | (fallback) |
| font-style-FormItemLabel | normal | normal |
| font-style-FormItemLabel-required | (fallback) | (fallback) |
| font-weight-FormItemLabel | $font-weight-medium | $font-weight-medium |
| font-weight-FormItemLabel-required | (fallback) | (fallback) |
