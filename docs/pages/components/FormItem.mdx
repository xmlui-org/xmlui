...
| [color-text](../styles-and-themes/common-units/#color-values)-FormItemLabel-required | (fallback) | (fallback) |
...
| [font-size](../styles-and-themes/common-units/#size-values)-FormItemLabel-required | (fallback) | (fallback) |
| font-style-FormItemLabel | normal | normal |
| font-style-FormItemLabel-required | (fallback) | (fallback) |
| [font-weight](../styles-and-themes/common-units/#font-weight-values)-FormItemLabel | $font-weight-medium | $font-weight-medium |
| [font-weight](../styles-and-themes/common-units/#font-weight-values)-FormItemLabel-required | (fallback) | (fallback) |
| text-transform-FormItemLabel | none | none |
| text-transform-FormItemLabel-required | (fallback) | (fallback) |
