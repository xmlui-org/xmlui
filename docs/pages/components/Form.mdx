...
| --- | --- | --- |
| [color](../styles-and-themes/common-units/#color-values)-accent-ValidationDisplay-error | $color-error | $color-danger-500 |
| [color](../styles-and-themes/common-units/#color-values)-accent-ValidationDisplay-info | $color-info | $color-surface-200 |
| [color](../styles-and-themes/common-units/#color-values)-accent-ValidationDisplay-valid | $color-valid | $color-success-600 |
| [color](../styles-and-themes/common-units/#color-values)-accent-ValidationDisplay-warning | $color-warning | $color-warn-700 |
| [color-bg](../styles-and-themes/common-units/#color-values)-ValidationDisplay-error | $color-danger-100 | $color-danger-900 |
| [color-bg](../styles-and-themes/common-units/#color-values)-ValidationDisplay-info | $color-primary-100 | $color-secondary-800 |
| [color-bg](../styles-and-themes/common-units/#color-values)-ValidationDisplay-valid | $color-success-100 | $color-success-900 |
| [color-bg](../styles-and-themes/common-units/#color-values)-ValidationDisplay-warning | $color-warn-100 | $color-warn-900 |
| [color](../styles-and-themes/common-units/#color-values)-text-ValidationDisplay-error | $color-error | $color-danger-500 |
| [color](../styles-and-themes/common-units/#color-values)-text-ValidationDisplay-info | $color-info | $color-secondary-200 |
| [color](../styles-and-themes/common-units/#color-values)-text-ValidationDisplay-valid | $color-valid | $color-success-600 |
| [color](../styles-and-themes/common-units/#color-values)-text-ValidationDisplay-warning | $color-warning | $color-warn-700 |
