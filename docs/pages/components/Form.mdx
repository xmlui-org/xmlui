...
| --- | --- | --- |
| color-accent-ValidationDisplay-error | $color-error | $color-danger-500 |
| color-accent-ValidationDisplay-info | $color-info | $color-surface-200 |
| color-accent-ValidationDisplay-valid | $color-valid | $color-success-600 |
| color-accent-ValidationDisplay-warning | $color-warning | $color-warn-700 |
| color-bg-ValidationDisplay-error | $color-danger-100 | $color-danger-900 |
| color-bg-ValidationDisplay-info | $color-primary-100 | $color-secondary-800 |
| color-bg-ValidationDisplay-valid | $color-success-100 | $color-success-900 |
| color-bg-ValidationDisplay-warning | $color-warn-100 | $color-warn-900 |
| color-text-ValidationDisplay-error | $color-error | $color-danger-500 |
| color-text-ValidationDisplay-info | $color-info | $color-secondary-200 |
| color-text-ValidationDisplay-valid | $color-valid | $color-success-600 |
| color-text-ValidationDisplay-warning | $color-warning | $color-warn-700 |
