...
This property defines the message to display when the data fetch operation has been completed.
...
This property defines the message to display when the data fetch operation results in an error.
...
This property defines the message to display when the data fetch operation is in progress.

### `method (default: "get")`

The method by which the data fetching request is made.

Available values: `get` **(default)**, `post`, `put`, `delete`
