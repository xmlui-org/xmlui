...
| color-bg-Table | $color-bg | $color-bg |
| color-bg-heading-Table | $color-surface-100 | $color-surface-950 |
| color-bg-heading-Table--active | $color-surface-300 | $color-surface-700 |
| color-bg-heading-Table--hover | $color-surface-200 | $color-surface-800 |
| color-bg-pagination-Table | $color-bg-Table | $color-bg-Table |
| color-bg-row-Table | (fallback) | (fallback) |
| color-bg-row-Table--hover | $color-primary-50 | $color-primary-900 |
| color-bg-selected-Table | $color-primary-100 | $color-primary-800 |
| color-bg-selected-Table--hover | $color-bg-row-Table--hover | $color-bg-row-Table--hover |
| color-border-cell-Table | $color-border | $color-border |
| color-outline-heading-Table--focus | $color-outline--focus | $color-outline--focus |
| color-text-Table | (fallback) | (fallback) |
| color-text-heading-Table | $color-surface-500 | (fallback) |
| color-text-pagination-Table | $color-secondary | $color-secondary |
| font-size-heading-Table | $font-size-tiny | $font-size-tiny |
| font-size-row-Table | $font-size-small | $font-size-small |
| font-weight-heading-Table | $font-weight-bold | $font-weight-bold |
| font-weight-row-Table | (fallback) | (fallback) |
...
| style-border-cell-Table | solid | solid |
| style-outline-heading-Table--focus | $style-outline--focus | $style-outline--focus |
| thickness-border-cell-Table | 1px | 1px |
| thickness-outline-heading-Table--focus | $thickness-outline--focus | $thickness-outline--focus |
