...
| [color-bg](../styles-and-themes/common-units/#color-values)-row-Table | (fallback) | (fallback) |
...
| [color-text](../styles-and-themes/common-units/#color-values)-Table | (fallback) | (fallback) |
| [color-text](../styles-and-themes/common-units/#color-values)-heading-Table | $color-surface-500 | (fallback) |
...
| [font-weight](../styles-and-themes/common-units/#font-weight-values)-row-Table | (fallback) | (fallback) |
