...
| [radius](../styles-and-themes/common-units/#border-rounding)-DropdownMenu | (fallback) | (fallback) |
...
| [thickness-border](../styles-and-themes/common-units/#size-values)-DropdownMenu-content | (fallback) | (fallback) |
