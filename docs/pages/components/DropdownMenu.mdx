...
| --- | --- | --- |
| color-MenuItem | (fallback) | (fallback) |
| color-MenuItem--active | (fallback) | (fallback) |
| color-MenuItem--active--hover | (fallback) | (fallback) |
| color-MenuItem--hover | (fallback) | (fallback) |
| color-MenuSeparator | (fallback) | (fallback) |
| color-bg-DropdownMenu | $color-bg-primary | $color-bg-primary |
| color-bg-MenuItem | (fallback) | (fallback) |
| color-bg-MenuItem--active | (fallback) | (fallback) |
| color-bg-MenuItem--active--hover | (fallback) | (fallback) |
| color-bg-MenuItem--hover | (fallback) | (fallback) |
| color-border-DropdownMenu-content | (fallback) | (fallback) |
| font-family-MenuItem | (fallback) | (fallback) |
| font-size-MenuItem | (fallback) | (fallback) |
...
| min-width-DropdownMenu | 160px | 160px |
...
| style-border-DropdownMenu-content | solid | solid |
