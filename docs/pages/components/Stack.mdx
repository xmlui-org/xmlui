...
### `visibleOnHover (optional)`

Reserved for future use

### `wrapContent (optional)`
...
| --- | --- | --- |
| [border](../styles-and-themes/common-units/#border)-Stack--hover | <GrayText>none</GrayText> | <GrayText>none</GrayText> |
| [color-bg](../styles-and-themes/common-units/#color)-Stack--hover | <GrayText>none</GrayText> | <GrayText>none</GrayText> |
