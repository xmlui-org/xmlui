...
| --- | --- | --- |
| [color-bg](../styles-and-themes/common-units/#color)-dropping-FileUploadDropZone | $color-bg--selected | $color-bg--selected |
| [color-bg](../styles-and-themes/common-units/#color)-FileUploadDropZone | $color-bg | $color-bg |
| [color-text](../styles-and-themes/common-units/#color)-FileUploadDropZone | $color-text | $color-text |
