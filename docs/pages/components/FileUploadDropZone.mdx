...
| --- | --- | --- |
| color-bg-FileUploadDropZone | $color-bg | $color-bg |
| color-bg-dropping-FileUploadDropZone | $color-bg--selected | $color-bg--selected |
| color-text-FileUploadDropZone | $color-text | $color-text |
