...
For the complete list of available `<propertyName>` values, see the [Theme Variables](/components/appearance/theme-variables/#property-names) article under "Component Reference".
