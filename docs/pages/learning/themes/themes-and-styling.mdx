...
1. You can set layout property values _directly_ (to a literal property value) one-by-one. This way of working with layout properties may cause a lot of extra work if you use too many of them in your app, and later, you must modify them.
