...
import { BASIC_COMPONENTS, BUILD_AND_DEPLOY, CODING_WITH_XMLUI, LAYOUT, LAYOUT_PROPERTIES, MARKUP, MODAL_DIALOGS, REUSABLE_COMPONENTS, ROUTING, THE_APP_COMPONENT, THEMES, USING_FORMS, WORKING_WITH_DATA, WORKING_WITH_RESOURCES, WORKING_WITH_TEXT } from '../meta/pages';
...
- <SmartLink href={ROUTING}>Routing</SmartLink>: Understand how you can navigate between different parts of an XMLUI app
...
- <SmartLink href={MODAL_DIALOGS}>Modal Dialogs</SmartLink>: Learn how to create and display modal dialogs in XMLUI apps
