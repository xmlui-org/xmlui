...
- [Markup](/create-apps/xmlui-markup): Learn the essence of the XMLUI markup language
- [Code](/create-apps/xmlui-code): Understand the coding fundamentals of XMLUI apps
- [The App Component](/create-apps/app-component): XMLUI provides an `App` component, supplying layout and UI logic services for the entire app
- [Layout](/create-apps/layout): Learn how to design the app's layout with XMLUI's simple layout system
- [Working with Text](/create-apps/text): Understand how you can display text in XMLUI apps
- [Basic Components](/create-apps/basic-components): Get acquainted with the basic components XMLUI provides for building apps
- [Working with Data](/create-apps/data): XMLUI makes accessing, displaying, manipulating, and persisting data extremely easy through web APIs. Learn how to use these features.
- [Routing](/create-apps/routing): Understand how you can navigate between different parts of an XMLUI app
- [Forms](/create-apps/forms): The framework has rich support for creating data entry and edit forms and managing their persistence
- [Modal Dialogs](/create-apps/dialogs): Learn how to create and display modal dialogs in XMLUI apps
- [Reusable Components](/create-apps/reusable-components): You can create and leverage your app-specific components using XMLUI markup
