...
<Playground
  ...
  height={500}
  app={`
    <App xmlns:XMLUIExtensions="component-ns">
      <CVStack>
        <XMLUIExtensions:PieChart data="{[{category: 'Direct', value: 34}, {category: 'Affilliate', value: 55}]}" dataKey="value" nameKey="category" showLegend="false" width="400" height="400">
            <XMLUIExtensions:Legend />
        </XMLUIExtensions:PieChart>
      </CVStack>
    </App>
  `}
/>
