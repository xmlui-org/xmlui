...
This introduction familiarizes you with the framework's fundamental concepts. This documentation contains helpful information to help you start, learn, and master creating apps with XMLUI. After going through the concepts, follow these links to get a flying start:


- [Getting Started](./getting-started) - Create your first XMLUI app
- Topic 2
