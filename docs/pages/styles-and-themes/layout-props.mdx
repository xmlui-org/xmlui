...
Sets the <SmartLink href={COMMON_VISUAL_PROPERTY_UNITS_SIZE}>thickness</SmartLink> of the border; uses the same value for the left, top, right, and bottom borders.
...
This property specifies the horizontal <SmartLink href={ COMMON_VISUAL_PROPERTY_UNITS_ALIGNMENT }>alignment</SmartLink> of child component within its parent.
...
This <SmartLink href={ COMMON_VISUAL_PROPERTY_UNITS_BOOLEAN }>boolean</SmartLink> property determines if the text should be displayed in italic style.
...
This property specifies the vertical <SmartLink href={ COMMON_VISUAL_PROPERTY_UNITS_ALIGNMENT }>alignment</SmartLink> of child component within its parent.
