...
```ueml copy /horizontalAlignment/ /verticalAlignment/
<App>
  <VStack>
    <HStack width="300" backgroundColor="cyan"
      horizontalAlignment="start">
      <Text>This is a text aligned to the start</Text>
    </HStack>
    <HStack width="300" backgroundColor="cyan"
      horizontalAlignment="center">
      <Text>This is a text aligned to the center</Text>
    </HStack>
    <HStack width="300" backgroundColor="cyan"
      horizontalAlignment="end">
      <Text>This is a text aligned to the end</Text>
    </HStack>
    <VStack height="100"
      ...
      horizontalAlignment="center">
      <Text>
        This text is aligned vertically to the bottom, horizontally to the center
      </Text>
    </VStack>
  </VStack>
</App>
