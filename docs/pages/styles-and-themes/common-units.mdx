...
- **Border width**. The stroke <SmartLink href="#size-values">width</SmartLink> to draw the border.
- **Border style**. The border <SmartLink href="#border-style-values">style pattern</SmartLink> to apply.
- **Border color**. The <SmartLink href="#color-values">color</SmartLink> of the border.
...
You can define border rounding values to round the corners of a component's outer border edge. You can set a single radius to make circular corners or two radii to make elliptical ones. Radius values use the <SmartLink href="#size-values">size value</SmartLink> syntax and semantics.
...
The first up to four <SmartLink href="#size-values">size value</SmartLink> segments are followed by the optional <SmartLink href="#color-values">color value</SmartLink>.
