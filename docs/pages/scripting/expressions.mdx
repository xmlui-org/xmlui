...
- In property values (property attributes or in the `<props>` section of components)
...
Arrow function arguments support the destructure pattern. You can learn more about them [here](./script-language#destructuring).
