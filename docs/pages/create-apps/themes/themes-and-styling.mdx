...
import { RESOURCES, THEME_VARIABLES } from "../../../meta/pages";
...
For the complete list of available `<propertyertyName>` values, see the <SmartLink href={THEME_VARIABLES + "#property-names"}>Theme Variables</SmartLink> article under "Component Reference".
...
See the <SmartLink href={THEME_VARIABLES + "#app-bound-traits"}>Theme Variables</SmartLink> article under "Component Reference" for the complete list of app-bound traits. You can check the traits of a particular component on its reference page.
...
For the complete list of available `<state>` values, see the <SmartLink href={THEME_VARIABLES + "#visual-states"}>Theme Variables</SmartLink> article in the Component Reference.
