...
You can read more details about layout properties and their usage in the <SmartLink href={}>Component Appearance</SmartLink> [Component Appearance](./component-appearance) article. Here, you will learn how to use, create, and modify themes.
...
For the complete list of available `<propertyertyName>` values, see the [Theme Variables](/components/appearance/theme-variables/#property-names) article under "Component Reference".
...
See the [Theme Variables](/components/appearance/theme-variables/#app-bound-traits) article under "Component Reference" for the complete list of app-bound traits. You can check the traits of a particular component on its reference page.
