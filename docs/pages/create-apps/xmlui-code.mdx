...
import { GLOBAL_FUNCTIONS_AND_VARIABLES, REUSABLE_COMPONENTS, REUSABLE_COMPONENTS_EXPOSING_METHODS, SCRIPT_SYNTAX, SCRIPT_SYNTAX_EVENT_HANDLERS, XMLUI_EXPRESSIONS } from '../../meta/pages'
