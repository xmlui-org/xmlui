...
<Callout type="info" emoji="💡">
    The nested tags in the XMLUI markup form a natural hierarchy of components. Parent components have children
    (directly or through their children or children's children, and so on).
</Callout>
...
<Callout type="info" emoji="💡">
    With the **`id` attribute** of a component tag, you can assign an identifier to a component that you can use to
    refer to that particular component in code (expressions).
</Callout>
