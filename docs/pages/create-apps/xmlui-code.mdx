...
The `{myText.value}` part in the Text component is a nested expression. The wrapping braces sign the engine that the content within will be evaluated as the app runs.
