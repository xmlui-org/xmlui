...
```ueml copy /color-text-primary="orangered"/ /borderRadius-Card="40px"/ /color-text-primary="mediumpurple"/
<App>
  <Theme color-text-primary="orangered" borderRadius-Card="40px">
...
<component-name>` theme variables.
    ...
    The key to this behavior is the `Input` component name within the `borderRadius-Input` and `color-bg-Input` variable
    names.
