...
- **Markup**. The XMLUI markup of the application, including the app definition and the app-specific components. This markup defines the appearance and the logic of the UI.
