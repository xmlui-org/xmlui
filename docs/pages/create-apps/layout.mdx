...
```ueml copy /horizontalAlignment="center"/
...
```ueml copy /horizontalAlignment="end"/
...
```ueml copy /width="1000000px"/
<FlowLayout>
  <Stack backgroundColor="red" height="36" width="1000000px" />
  <Stack backgroundColor="green" height="36" width="50%" />
  <Stack backgroundColor="blue" height="36" width="25%" />
</FlowLayout>
```
