...
```ueml copy /friends.value.toSorted((a, b) => b.age - a.age)/
<App>
...
```ueml copy {3} /5e9d0d95eda69955f709d1eb/ /$param/
<App 
  var.rocketData="">
...
```ueml copy {4-8} /$params[0]/ /$params[1]/ /execute/
<App>
