...
```xmlui-pg
---app copy display name="Example: Explicit data" height="240px"
<App>
...
```xmlui-pg
---app copy display name="Example: Data with a URL" height="240px"
<App>
...
```xmlui-pg
---app copy display name="Example: Data with a non-functional URL" height="180px"
<App var.myData="{[]}">
...
```xmlui-pg copy
---app copy display name="Example: Using DataSource in Data" height="260px"
<App>
