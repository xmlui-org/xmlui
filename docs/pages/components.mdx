...
| 47 | [Markdown](./components/Markdown.mdx) | `Markdown` displays plain text styled with markdown syntax. | stable |
...
| 67 | [Slider](./components/Slider.mdx) | The `Slider` component allows you to select a numeric value between a range specified by minimum and maximum values. | experimental |
...
| 84 | [VSplitter](./components/VSplitter.mdx) | The `Splitter` component divides a container (such as a window, panel, pane, etc.) into two resizable sections. | stable |
