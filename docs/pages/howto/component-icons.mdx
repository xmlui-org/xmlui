...
> **Note:** The following examples all use the same dataset that the `Table` component [reference documentation](../components/Table.mdx) uses.
...
XMLUI uses the same concept here as it does regarding [theme variable chaining](../learning/themes/themes-and-styling.mdx#theme-variable-chaining).
