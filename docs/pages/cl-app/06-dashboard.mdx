...
import { CL_TUTORIAL_6, CL_TUTORIAL_FINAL } from '../../meta/downloads'
...
You can continue working with the code you completed in the previous tutorial section. Alternatively, you can download the code from <DownloadLink href={CL_TUTORIAL_6}>here</DownloadLink> and carry on. 
</Callout>
...
<Callout type="info" emoji="📔">
You can download the code of the completed tutorial from here. <DownloadLink href={CL_TUTORIAL_FINAL}>here</DownloadLink>. 
</Callout>
