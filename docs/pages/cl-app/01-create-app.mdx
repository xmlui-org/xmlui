...
Spin up your web server pointing to the unzipped folder where the sample code of the starter app is located.
Then, visit the server's default page in your browser.
