...
<Callout emoji="💡">
  ...
  If you have Node.js installed on your machine, you can use the `start.bat` or `start.sh` files (from the app's directory) to ignite the web server and open the app in the browser.
</Callout>
