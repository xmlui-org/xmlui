...
import { CL_TUTORIAL_3 } from '../../meta/downloads'

# Filter Data

<Callout type="info" emoji="📔">
You can continue working with the code you completed in the previous tutorial section. Alternatively, you can download the code from <DownloadLink href={CL_TUTORIAL_3}>here</DownloadLink> and carry on. 
</Callout>
...
Previously, you set the `datasource` property of the `List` binding it to the fetched data.
You cannot do this direct binding now, as you have to filter the fetched data before passing it to `List`.
