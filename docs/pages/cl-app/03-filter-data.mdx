...
```ueml copy {13-17, 21, 24-27} filename="Main.xmlui"
<App 
...
```ueml copy {7} filename="Main.xmlui" /id="contactsDs"/
<App 
  layout="vertical-sticky" 
  name="Contact List Tutorial" 
  logo="resources/logo.svg" 
...
```ueml copy {2-16} filename="Contacts.xmlui"
<Component name="Contacts">
  <List data="{contactsDs}">
...
```ueml copy filename="Contacts.xmlui" /data="{$props.data}"/
<Component name="Contacts">
...
```ueml copy {2} filename="Contacts.xmlui"
<Component name="Contacts">
