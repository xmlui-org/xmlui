...
The `List` component supports sections that group list items according to a particular section value. You will update the All Contacts list to leverage this feature.
