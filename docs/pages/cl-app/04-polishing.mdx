...
import { CL_TUTORIAL_4 } from '../../meta/downloads'
...
You can continue working with the code you completed in the previous tutorial section. Alternatively, you can download the code from <DownloadLink href={CL_TUTORIAL_4}>here</DownloadLink> and carry on. 
</Callout>
...
```ueml copy {3-4} filename="Contacts.xmlui" /section: getSection(t)/
