...
import { CL_TUTORIAL_2 } from '../../meta/downloads'
...
You can continue working with the code you completed in the previous tutorial section. Alternatively, you can download the code from <DownloadLink href={CL_TUTORIAL_2}>here</DownloadLink> and carry on. 
</Callout>
