...
const mock: ApiInterceptorDefinition = {
  ...
  operations: {
    ...
    makeError: {
      url: "/doError",
      method: "get",
      handler: "throw 'this is en error'"
    },
    ...
    "shopping-list-pagination": {
      ...
      handler: `
        ...
        const { size, prevPageParam } = $queryParams;
        
        const endIndex = prevPageParam !== undefined ? prevPageParam - 1 : items.length;
        return items.slice(endIndex - size, endIndex);`
    },
