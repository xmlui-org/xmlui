...
This component is inherited from <SmartLink href="/new-components/Splitter">Splitter</SmartLink>

See also: <SmartLink href="/new-components/VSplitter">VSplitter</SmartLink>
