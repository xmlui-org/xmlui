...
<Callout type="info" emoji="💡">
  When properties cannot be represented with a string, you nest them into their related component with the **`<propertyerty>` tag**. [Learn more!](./learning/xmlui-markup/#properties)
</Callout>
