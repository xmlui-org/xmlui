...
export const COMPONENT_CAROUSEL = "/components/Carousel";
...
export const MODAL_DIALOGS = "/create-apps/dialogs";
...
export const ROUTING = "/create-apps/routing";
...
export const COMPLEX_RADIOGROUP_LAYOUTS = "/howto/complex-radiogroup-layout";
...
export const APPLY_SELECTION_LIMITS_TO_DATEPICKER = "/howto/datepicker-restrictions";
export const HOW_TO_EVENTS = "/howto/events";
export const HOW_TO_LAYOUT = "/howto/layout";
export const MENUS = "/howto/menus";
export const DATA_MANIPULATION_WITH_APICALL = "/howto/working-with-apiactions";
