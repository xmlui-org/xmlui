...
test("Imperative open - without params", async ({ page }) => {
  await initApp(page, {
    entryPoint: `
      <App>
...
test("Imperative open - with param inside", async ({ page }) => {
  await initApp(page, {
    entryPoint: `
      <App>
...
test("Imperative open - with multiple param inside", async ({ page }) => {
  await initApp(page, {
    entryPoint: `
      <App>
...
test("Imperative open - with param in title", async ({ page }) => {
  await initApp(page, {
    entryPoint: `
      <App>
        <Button testId="button" onClick="modal.open('PARAM_VALUE')">open modal (imperative)</Button>
