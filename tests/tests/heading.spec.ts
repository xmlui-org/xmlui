...
const THEME_TESTS: ThemeTestDesc[] = [
  ...
  { themeVar: "color-Heading", themeVarAsCSS: "color", expected: RED },
  ...
  { themeVar: "letterSpacing-Heading", themeVarAsCSS: "letter-spacing", expected: "2px" },
  { themeVar: "textDecorationLine-Heading", themeVarAsCSS: "text-decoration-line", expected: "underline" },
  { themeVar: "marginTop-H1", themeVarAsCSS: "margin-top", expected: "30px" },
  { themeVar: "marginBottom-H1", themeVarAsCSS: "margin-bottom", expected: "30px" },
