...
mkdir -p /Users/dotneteer/source/xmlui/tools/vscode/test-samples

# Generate a more complex test file
cat > /Users/dotneteer/source/xmlui/tools/vscode/test-samples/complex-sample.xmlui << 'EOF'
...
echo "Created test sample at /Users/dotneteer/source/xmlui/tools/vscode/test-samples/complex-sample.xmlui"
