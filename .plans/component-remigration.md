...
| Audit required | Component exists in the rewrite but has not passed the new protected-file audit. | 30 |
...
| Complete | User approved after audit and verification. | 82 |
...
- Completed-component regression cleanup after the broad `test:e2e` failure list:
  ...
  flake before hovering for tooltip.
