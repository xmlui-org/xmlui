...
| Audit required | Component exists in the rewrite but has not passed the new protected-file audit. | 63 |
...
| Complete | User approved after audit and verification. | 49 |
