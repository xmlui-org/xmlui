...
| Audit required | Component exists in the rewrite but has not passed the new protected-file audit. | 88 |
...
| Complete | User approved after audit and verification. | 16 |
