...
| Audit required | Component exists in the rewrite but has not passed the new protected-file audit. | 60 |
...
| Complete | User approved after audit and verification. | 52 |
