...
- `FlowLayout`: responsive width inference, `SpaceFiller` line breaks, star
  sizing, non-visual child elision, scroller/fade behavior, scroll APIs,
  snapshots, and full layout matrix;
