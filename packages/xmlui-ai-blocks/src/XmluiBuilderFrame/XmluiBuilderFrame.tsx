...
export const XmluiBuilderFrameMd = createMetadata({
  ...
  props: {
    ...
    resizable: {
      description:
        "When enabled, the split layout includes an accessible divider between chat and workspace with pointer and keyboard resizing.",
      valueType: "boolean",
  ...
  defaultThemeVars: {
    ...
    [`borderRadius-XmluiBuilderFrame`]: "$space-2",
    [`boxShadow-XmluiBuilderFrame`]: "none",
    ...
    [`minHeight-XmluiBuilderFrame`]: "30rem",
    [`gap-XmluiBuilderFrame`]: "$space-2",
    [`gap-panel-XmluiBuilderFrame`]: "$space-2",
    [`padding-XmluiBuilderFrame`]: "$space-3",
    [`padding-panel-XmluiBuilderFrame`]: "$space-3",
    [`padding-toolbar-XmluiBuilderFrame`]: "$space-2",
    [`padding-status-XmluiBuilderFrame`]: "$space-2",
    [`padding-tabs-XmluiBuilderFrame`]: "$space-1",
