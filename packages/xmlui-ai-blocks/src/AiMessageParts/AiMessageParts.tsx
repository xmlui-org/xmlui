...
export const AiMessagePartsMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`backgroundColor-${COMP}--assistant`]: "$color-surface-50",
    [`backgroundColor-${COMP}--user`]: "rgb(from $color-primary-100 r g b / 0.55)",
    [`backgroundColor-${COMP}--system`]: "rgb(from $color-secondary-100 r g b / 0.55)",
    [`backgroundColor-${COMP}--tool`]: "rgb(from $color-attention-100 r g b / 0.55)",
    ...
    dark: {
      ...
      [`backgroundColor-${COMP}--assistant`]: "$color-surface-200",
      [`backgroundColor-${COMP}--user`]: "rgb(from $color-primary-300 r g b / 0.20)",
