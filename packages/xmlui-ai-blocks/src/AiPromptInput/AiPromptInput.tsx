...
export const AiPromptInputMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`backgroundColor-control-${COMP}`]: "$color-surface-50",
    [`backgroundColor-control-${COMP}--hover`]: "$color-surface-100",
    [`borderColor-control-${COMP}`]: "$borderColor",
    ...
    dark: {
      ...
      [`backgroundColor-control-${COMP}`]: "$color-surface-200",
      [`backgroundColor-control-${COMP}--hover`]: "$color-surface-300",
