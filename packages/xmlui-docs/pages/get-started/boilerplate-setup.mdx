...
3. The utility installs the `@nsoftware-com/xmlui` package, the only direct dependency you need to develop XMLUI apps. This package will pull necessary dependencies automatically. After the download is complete (it may take one or two minutes the first time), the tool sets up your XMLUI development project.
