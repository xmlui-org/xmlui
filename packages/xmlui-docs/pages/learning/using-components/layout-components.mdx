...
Child components may declare one or more of these [dimensions](./layout/#component-width-and-height): `width`, `height`, `minWidth`, `minHeight`, `maxWidth`, and `maxHeight`.
...
> **Note**: You should know a few additional layout-related things about [reusable components](./reusable-components/#reusable-components-in-layout-containers).
