...
If you do want to hide the ellipses, set the `noEllipses` property to `true`:
...
> **Note**: Remember, you can use the `noEllipsis` prop to remove the ellipsis from the end of the cropped text.
