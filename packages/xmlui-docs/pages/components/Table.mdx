...
`Table` is a component displaying cells organized into rows and columns. `Table` is virtualized; it renders only the visible cells (according to the current viewport).
