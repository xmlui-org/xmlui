...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      if (labelFormatter) {
        return (
          <div className={classnames(styles.fontMedium, labelClassName)}>
      ...
      return <div className={classnames(styles.fontMedium, labelClassName)}>{value}</div>;
    ...
    return (
      <div ref={ref} className={classnames(styles.tooltipContainer, className)}>
            ...
            return (
              <div
                ...
                className={classnames(styles.itemContainer, {
                  [styles.itemsCenter]: indicator === "dot",
                })}
              >
                {formatter && item?.value !== undefined && item.name ? (
                  ...
                  <>
                    {itemConfig?.icon ? (
                      ...
                      !hideIndicator && (
                        <div
                          className={classnames(styles.indicatorBase, {
                    ...
                    <div
                      className={classnames(styles.valueContainer, {
                        [styles.itemsEnd]: nestLabel,
                      })}
                    >
                      <div className={styles.labelGrid}>
                        {nestLabel ? tooltipLabel : null}
                        <span className={styles.mutedText}>{itemConfig?.label || item.name}</span>
                      </div>
                      {item.value && (
