import { Statement } from "../abstractions/scripting/ScriptingSourceTree.js";
...
function mapStatementToQueueItem (statement: Statement): StatementQueueItem {
  return {
    label: nextLabelValue++,
    statement: { ...statement }
  };
...
export function mapStatementsToQueueItems (statements: Statement[]): StatementQueueItem[] {
