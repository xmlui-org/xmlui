...
import { UemlInputStream } from "./UemlInputStream";
import { HARD_LITERAL_END, HARD_LITERAL_START, SCRIPT_LITERAL_END, SCRIPT_LITERAL_START, UemlLexer } from "./UemlLexer";
import { UemlTokenType } from "./UemlToken";
import { errorMessages, ParserError } from "./ParserError";
import { COMPOUND_COMP_ID, onPrefixRegex, UCRegex } from "./UemlHelper";
import { Parser } from "../scripting/Parser";
import { collectCodeBehindFromSource } from "../scripting/code-behind-collect";
import { createEvalContext, ModuleResolver } from "../../components-core/script-runner/BindingTreeEvaluationContext";
