...
| --- | --- | --- |
| [animationDuration-Drawer](/docs/styles-and-themes/layout-props/#animationDuration) | 250ms | 250ms |
| [animationEasing-Drawer](/docs/styles-and-themes/layout-props/#animation) | cubic-bezier(0.4, 0, 0.2, 1) | cubic-bezier(0.4, 0, 0.2, 1) |
| [backgroundColor-backdrop-Drawer](/docs/styles-and-themes/common-units/#color) | rgba(0, 0, 0, 0.4) | rgba(0, 0, 0, 0.4) |
| [backgroundColor-Drawer](/docs/styles-and-themes/common-units/#color) | $backgroundColor-primary | $backgroundColor-primary |
| [borderRadius-Drawer](/docs/styles-and-themes/common-units/#border-rounding) | $borderRadius | $borderRadius |
| [boxShadow-Drawer](/docs/styles-and-themes/common-units/#boxShadow) | 0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05) | 0 10px 15px -3px rgba(0,0,0,0.1), 0 4px 6px -2px rgba(0,0,0,0.05) |
| [gap-Drawer](/docs/styles-and-themes/common-units/#size) | $space-4 | $space-4 |
| [height-Drawer](/docs/styles-and-themes/common-units/#size-values) | 320px | 320px |
| [maxHeight-Drawer](/docs/styles-and-themes/common-units/#size-values) | 50% | 50% |
| [maxWidth-Drawer](/docs/styles-and-themes/common-units/#size-values) | 80% | 80% |
| [padding-Drawer](/docs/styles-and-themes/common-units/#size-values) | $paddingTop-Drawer $paddingRight-Drawer $paddingBottom-Drawer $paddingLeft-Drawer | $paddingTop-Drawer $paddingRight-Drawer $paddingBottom-Drawer $paddingLeft-Drawer |
| [paddingBottom-Drawer](/docs/styles-and-themes/common-units/#size-values) | $paddingVertical-Drawer | $paddingVertical-Drawer |
| [paddingHorizontal-Drawer](/docs/styles-and-themes/common-units/#size-values) | $space-4 | $space-4 |
| [paddingLeft-Drawer](/docs/styles-and-themes/common-units/#size-values) | $paddingHorizontal-Drawer | $paddingHorizontal-Drawer |
| [paddingRight-Drawer](/docs/styles-and-themes/common-units/#size-values) | $paddingHorizontal-Drawer | $paddingHorizontal-Drawer |
| [paddingTop-Drawer](/docs/styles-and-themes/common-units/#size-values) | $paddingVertical-Drawer | $paddingVertical-Drawer |
| [paddingVertical-Drawer](/docs/styles-and-themes/common-units/#size-values) | $space-4 | $space-4 |
| right-closeButton-Drawer | $space-3 | $space-3 |
| top-closeButton-Drawer | $space-2 | $space-2 |
| [width-Drawer](/docs/styles-and-themes/common-units/#size-values) | 320px | 320px |
