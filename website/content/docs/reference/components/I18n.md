...
- **Scoped locale overrides**: Uses the nearest [Locale](/docs/reference/components/Locale) wrapper when one is present.
...
```xmlui-pg copy display name="Example: scoped translations"
<App
  locale="en-US"
  localeBundles="{{
