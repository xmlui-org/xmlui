...
| --- | --- | --- |
| [backgroundColor-buttonRow-Form](/docs/styles-and-themes/common-units/#color) | transparent | transparent |
| [backgroundColor-Form](/docs/styles-and-themes/common-units/#color) | transparent | transparent |
| [backgroundColor-ValidationDisplay-error](/docs/styles-and-themes/common-units/#color) | $color-danger-100 | $color-danger-100 |
| [backgroundColor-ValidationDisplay-info](/docs/styles-and-themes/common-units/#color) | $color-primary-100 | $color-primary-100 |
| [backgroundColor-ValidationDisplay-valid](/docs/styles-and-themes/common-units/#color) | $color-success-100 | $color-success-100 |
| [backgroundColor-ValidationDisplay-warning](/docs/styles-and-themes/common-units/#color) | $color-warn-100 | $color-warn-100 |
| [color-accent-ValidationDisplay-error](/docs/styles-and-themes/common-units/#color) | $color-error | $color-error |
| [color-accent-ValidationDisplay-info](/docs/styles-and-themes/common-units/#color) | $color-info | $color-info |
| [color-accent-ValidationDisplay-valid](/docs/styles-and-themes/common-units/#color) | $color-valid | $color-valid |
| [color-accent-ValidationDisplay-warning](/docs/styles-and-themes/common-units/#color) | $color-warning | $color-warning |
| [gap-buttonRow-Form](/docs/styles-and-themes/common-units/#size) | $space-4 | $space-4 |
| [gap-Form](/docs/styles-and-themes/common-units/#size) | $space-4 | $space-4 |
| [marginTop-buttonRow-Form](/docs/styles-and-themes/common-units/#size-values) | $space-4 | $space-4 |
| [paddingTop-buttonRow-Form](/docs/styles-and-themes/common-units/#size-values) | 0 | 0 |
| [textColor-ValidationDisplay-error](/docs/styles-and-themes/common-units/#color) | $color-error | $color-error |
| [textColor-ValidationDisplay-info](/docs/styles-and-themes/common-units/#color) | $color-info | $color-info |
| [textColor-ValidationDisplay-valid](/docs/styles-and-themes/common-units/#color) | $color-valid | $color-valid |
| [textColor-ValidationDisplay-warning](/docs/styles-and-themes/common-units/#color) | $color-warning | $color-warning |
