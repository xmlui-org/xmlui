...
```xmlui-pg name="Modal Dialogs" display {2, 3, 19} id="modal-dialogs-b6ec"
<App>
...
```xmlui-pg name="Modal Dialogs 2" display {3, 7, 19} id="modal-dialogs-b758"
<App>
  <ModalDialog
    id="dialog"
    title="Leslie Peters">
...
```xmlui-pg name="Modal Dialogs 3" display {3, 23} height="400px" id="modal-dialogs-b7dc"
<App>
...
```xmlui-pg name="Modal Dialogs 4" display height="220px" id="when-to-use-declarative-vs-imperative-modals-b851"
<App>
