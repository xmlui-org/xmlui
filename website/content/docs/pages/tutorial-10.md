...
```xmlui-pg name="Search" display  noHeader id="search-b76c"
---app display
<App>
  <Search />
</App>
...
```xmlui-pg name="Search invoices after date"  noHeader id="search-invoices-after-date-b82e"
---app display
<App>
  <SearchInvoicesAfter />
</App>
...
```xmlui-pg name="Search everything" height="400px"  noHeader id="search-everything-b9b3"
---app
<App>
  <SearchEverything />
</App>
