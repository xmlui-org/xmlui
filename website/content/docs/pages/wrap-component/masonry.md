...
```xmlui-pg name="Basic: colored boxes with varying heights" id="basic-colored-boxes-with-varying-heights-b6be"
---app display
<App>
...
```xmlui-pg name="Content cards: simulated event listings" id="content-cards-simulated-event-listings-b82e"
---app display
<App>
