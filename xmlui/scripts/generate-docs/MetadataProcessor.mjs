...
import { processComponentSection } from "./pattern-utilities.mjs";
import {
  METADATA_SECTIONS,
  DIRECTIVE_CONFIG,
...
const themeKeywordLinks = {
  ...
  color: "[color](/docs/styles-and-themes/common-units/#color)",
  borderColor: "[borderColor](/docs/styles-and-themes/common-units/#color)",
  borderBottomColor: "[borderBottomColor](/docs/styles-and-themes/common-units/#color)",
  borderTopColor: "[borderTopColor](/docs/styles-and-themes/common-units/#color)",
  borderHorizontalColor: "[borderHorizontalColor](/docs/styles-and-themes/common-units/#color)",
  borderVerticalColor: "[borderVerticalColor](/docs/styles-and-themes/common-units/#color)",
  borderRightColor: "[borderRightColor](/docs/styles-and-themes/common-units/#color)",
  borderLeftColor: "[borderLeftColor](/docs/styles-and-themes/common-units/#color)",
  backgroundColor: "[backgroundColor](/docs/styles-and-themes/common-units/#color)",
  textDecorationColor: "[textDecorationColor](/docs/styles-and-themes/common-units/#color)",
  textColor: "[textColor](/docs/styles-and-themes/common-units/#color)",
  fill: "[fill](/docs/styles-and-themes/common-units/#color)",
  stroke: "[stroke](/docs/styles-and-themes/common-units/#color)",
  fontWeight: "[fontWeight](/docs/styles-and-themes/common-units/#fontWeight)",
  rounding: "[rounding](/docs/styles-and-themes/common-units/#border-rounding)",
  borderStyle: "[borderStyle](/docs/styles-and-themes/common-units/#border-style)",
  borderBottomStyle: "[borderBottomStyle](/docs/styles-and-themes/common-units/#border-style)",
  borderTopStyle: "[borderTopStyle](/docs/styles-and-themes/common-units/#border-style)",
  borderHorizontalStyle: "[borderHorizontalStyle](/docs/styles-and-themes/common-units/#border-style)",
  borderVerticalStyle: "[borderVerticalStyle](/docs/styles-and-themes/common-units/#border-style)",
  borderRightStyle: "[borderRightStyle](/docs/styles-and-themes/common-units/#border-style)",
  borderLeftStyle: "[borderLeftStyle](/docs/styles-and-themes/common-units/#border-style)",
  size: "[size](/docs/styles-and-themes/common-units/#size-values)",
  fontSize: "[fontSize](/docs/styles-and-themes/common-units/#size-values)",
  height: "[height](/docs/styles-and-themes/common-units/#size-values)",
  minHeight: "[minHeight](/docs/styles-and-themes/common-units/#size-values)",
  maxHeight: "[maxHeight](/docs/styles-and-themes/common-units/#size-values)",
  width: "[width](/docs/styles-and-themes/common-units/#size-values)",
  minWidth: "[minWidth](/docs/styles-and-themes/common-units/#size-values)",
  maxWidth: "[maxWidth](/docs/styles-and-themes/common-units/#size-values)",
  distance: "[distance](/docs/styles-and-themes/common-units/#size-values)",
  thickness: "[thickness](/docs/styles-and-themes/common-units/#size-values)",
  borderWidth: "[borderWidth](/docs/styles-and-themes/common-units/#size-values)",
  borderBottomWidth: "[borderBottomWidth](/docs/styles-and-themes/common-units/#size-values)",
  borderTopWidth: "[borderTopWidth](/docs/styles-and-themes/common-units/#size-values)",
  borderHorizontalWidth: "[borderHorizontalWidth](/docs/styles-and-themes/common-units/#size-values)",
  borderVerticalWidth: "[borderVerticalWidth](/docs/styles-and-themes/common-units/#size-values)",
  borderRightWidth: "[borderRightWidth](/docs/styles-and-themes/common-units/#size-values)",
  borderLeftWidth: "[borderLeftWidth](/docs/styles-and-themes/common-units/#size-values)",
  textDecorationThickness: "[textDecorationThickness](/docs/styles-and-themes/common-units/#size-values)",
  strokeWidth: "[strokeWidth](/docs/styles-and-themes/common-units/#size-values)",
  offset: "[offset](/docs/styles-and-themes/common-units/#size-values)",
  padding: "[padding](/docs/styles-and-themes/common-units/#size-values)",
  paddingTop: "[paddingTop](/docs/styles-and-themes/common-units/#size-values)",
  paddingRight: "[paddingRight](/docs/styles-and-themes/common-units/#size-values)",
  paddingBottom: "[paddingBottom](/docs/styles-and-themes/common-units/#size-values)",
  paddingLeft: "[paddingLeft](/docs/styles-and-themes/common-units/#size-values)",
  paddingHorizontal: "[paddingHorizontal](/docs/styles-and-themes/common-units/#size-values)",
  paddingVertical: "[paddingVertical](/docs/styles-and-themes/common-units/#size-values)",
  margin: "[margin](/docs/styles-and-themes/common-units/#size-values)",
  marginTop: "[marginTop](/docs/styles-and-themes/common-units/#size-values)",
  marginBottom: "[marginBottom](/docs/styles-and-themes/common-units/#size-values)",
  marginLeft: "[marginLeft](/docs/styles-and-themes/common-units/#size-values)",
  marginRight: "[marginRight](/docs/styles-and-themes/common-units/#size-values)",
  textDecorationLine: "[textDecorationLine](/docs/styles-and-themes/common-units/#textDecoration)",
  lineHeight: "[lineHeight](/docs/styles-and-themes/common-units/#size-values)",
  borderEndEndRadius: "[borderEndEndRadius](/docs/styles-and-themes/common-units/#border-rounding)",
  borderEndStartRadius:
    "[borderEndStartRadius](/docs/styles-and-themes/common-units/#border-rounding)",
  borderStartEndRadius:
    "[borderStartEndRadius](/docs/styles-and-themes/common-units/#border-rounding)",
  borderStartStartRadius:
    "[borderStartStartRadius](/docs/styles-and-themes/common-units/#border-rounding)",
  borderRadius: "[borderRadius](/docs/styles-and-themes/common-units/#border-rounding)",
  borderHorizontal: "[borderHorizontal](/docs/styles-and-themes/common-units/#border)",
  borderVertical: "[borderVertical](/docs/styles-and-themes/common-units/#border)",
  border: "[border](/docs/styles-and-themes/common-units/#border)",
  borderLeft: "[borderLeft](/docs/styles-and-themes/common-units/#border)",
  borderRight: "[borderRight](/docs/styles-and-themes/common-units/#border)",
  borderTop: "[borderTop](/docs/styles-and-themes/common-units/#border)",
  borderBottom: "[borderBottom](/docs/styles-and-themes/common-units/#border)",
  boxShadow: "[boxShadow](/docs/styles-and-themes/common-units/#boxShadow)",
  direction: "[direction](/docs/styles-and-themes/layout-props#direction)",
  gap: "[gap](/docs/styles-and-themes/common-units/#size)",
  horizontalAlignment: "[horizontalAlignment](/docs/styles-and-themes/common-units/#alignment)",
  verticalAlignment: "[verticalAlignment](/docs/styles-and-themes/common-units/#alignment)",
  alignment: "[alignment](/docs/styles-and-themes/common-units/#alignment)",
  fontFamily: "[fontFamily](/docs/styles-and-themes/common-units/#fontFamily)",
  fontStretch: "[fontStretch](/docs/styles-and-themes/common-units/#fontStretch)",
  fontStyle: "[fontStyle](/docs/styles-and-themes/common-units/#fontStyle)",
  letterSpacing: "[letterSpacing](/docs/styles-and-themes/common-units/#size-values)",
  textDecorationStyle: "[textDecorationStyle](/docs/styles-and-themes/common-units/#textDecoration)",
  textDecorationThickness:
    "[textDecorationThickness](/docs/styles-and-themes/common-units/#textDecoration)",
  textTransform: "[textTransform](/docs/styles-and-themes/common-units/#textTransform)",
  "maxWidth-content": "[maxWidth-content](/docs/styles-and-themes/common-units/#size-values)",
  outlineStyle: "[outlineStyle](/docs/styles-and-themes/common-units/#border)",
  outlineWidth: "[outlineWidth](/docs/styles-and-themes/common-units/#size-values)",
  outlineColor: "[outlineColor](/docs/styles-and-themes/common-units/#color)",
  outlineOffset: "[outlineOffset](/docs/styles-and-themes/common-units/#size-values)",
  textUnderlineOffset: "[textUnderlineOffset](/docs/styles-and-themes/common-units/#size-values)",
  opacity: "[opacity](/docs/styles-and-themes/common-units/#opacity)",
  cursor: "[cursor](/docs/styles-and-themes/common-units/#cursor)",
  fontVariant: "[fontVariant](/docs/styles-and-themes/common-units/#font-variant)",
  lineBreak: "[lineBreak](/docs/styles-and-themes/common-units/#line-break)",
  textAlign: "[textAlign](/docs/styles-and-themes/common-units/#text-align)",
  textAlignLast: "[textAlignLast](/docs/styles-and-themes/common-units/#text-align)",
  textIndent: "[textIndent](/docs/styles-and-themes/common-units/#text-indent)",
  textShadow: "[textShadow](/docs/styles-and-themes/common-units/#text-shadow)",
  wordBreak: "[wordBreak](/docs/styles-and-themes/common-units/#word-break)",
  wordSpacing: "[wordSpacing](/docs/styles-and-themes/common-units/#word-spacing)",
  wordWrap: "[wordWrap](/docs/styles-and-themes/common-units/#word-wrap)",
  writingMode: "[writingMode](/docs/styles-and-themes/common-units/#writing-mode)",
  transition: "[transition](/docs/styles-and-themes/common-units/#transition)",
};
