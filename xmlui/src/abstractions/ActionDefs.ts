...
export interface ActionExecutionContext {
  ...
  navigate: any; //TEMPORARY stuff, we could use the one in the appContext, but until https://github.com/remix-run/react-router/issues/7634 fixed we can't
  location: any; //TEMPORARY stuff, we could use the one in the appContext, but until https://github.com/remix-run/react-router/issues/7634 fixed we can't
}
