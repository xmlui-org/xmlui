...
export const XmlUiBlogThemeDefinition: ThemeDefinition = {
  ...
  themeVars: {
    ...
    "textColor-Text-description": "$color-surface-600",
    "textColor-Text-description--hover": "$color-surface-600",
    "fontSize-Text-description": "18px",
    "fontWeight-Text-description": "bold",
    "textColor-Text-blurb": "$color-surface-500",
    "textColor-Text-blurb--hover": "$color-surface-500",
    "textColor-Text": "$color-surface-700",
    "textColor-H2": "$color-surface-600",
    "textColor-H1": "$color-surface-600",
