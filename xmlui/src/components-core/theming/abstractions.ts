...
/**
 * This type represents the object managing app themes. When an app runs,  styles are applied
 * according to the current (active) application theme and tone.
 */
export type AppThemes = {
  /**
   * Represents the root HTML element the theme is assigned to
   */
  root: HTMLElement | undefined;
