...
import { Select2, defaultProps } from "./Select2Native";
...
export const Select2Md = createMetadata({
  status: "stable",
  description:
    "`Select2` provides a dropdown interface for choosing from a list of options, " +
    ...
    "custom templates, and comprehensive form integration. This component maintains " +
    "API compatibility with the original Select component.",
  parts: {
    clearButton: {
      description: "The button to clear the selected value(s).",
    },
    item: {
      description: "Each option item within the Select2 component.",
    },
    menu: {
      description: "The dropdown menu within the Select2 component.",
    },
  },
  props: {
    placeholder: {
