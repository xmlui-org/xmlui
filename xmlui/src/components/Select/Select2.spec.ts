...
test.describe("Basic Functionality", () => {
  ...
  test("initialValue set to first valid value", async ({ page, initTestBed }) => {
    await initTestBed(`
    <Fragment>
      <Select2 id="mySelect" initialValue="{0}">
  ...
  test("initialValue set to non-existant option", async ({ page, initTestBed }) => {
    await initTestBed(`
    <Fragment>
      <Select2 id="mySelect" initialValue="{42}">
        <Option value="{0}" label="Zero"/>
        <Option value="{1}" label="One"/>
        <Option value="{2}" label="Two"/>
      </Select2>
  ...
  test("readOnly Select shows options, but value cannot be changed", async ({
    ...
    await initTestBed(`
    <Select2 readOnly initialValue="1">
      <Option value="1" label="One"/>
      <Option value="2" label="Two"/>
    </Select2>
    `);
  ...
  test("readOnly multi-Select shows options, but value cannot be changed", async ({
    ...
    await initTestBed(`
    <Select2 readOnly initialValue="{[1, 2]}" multiSelect>
      <Option value="1" label="One"/>
      <Option value="2" label="Two"/>
  ...
  test(
    ...
    async ({ initTestBed, page, createSelectDriver }) => {
      await initTestBed(`
    <Select2 label="Choose an option">
      <Option value="1" label="One"/>
      <Option value="2" label="Two"/>
    </Select2>
  `);
  ...
  test("autoFocus brings the focus to component", async ({
    ...
    <Select2 testId="focused-select" autoFocus>
      <Option value="1" label="One"/>
      <Option value="2" label="Two"/>
    </Select2>
    `);
  ...
  test("placeholder is shown", async ({ initTestBed, page, createSelectDriver }) => {
    await initTestBed(`
      <Select2 placeholder="Please select an item">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
      </Select2>
  ...
  test("clicking clear button clears single selection", async ({
    ...
    await initTestBed(`
      <Select2 id="mySelect" clearable="true">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
      </Select2>
    `);
  ...
  test("clear button works with multiSelect", async ({ initTestBed, createSelectDriver, page }) => {
    await initTestBed(`
      <Select2 clearable="true" multiSelect="true">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
      </Select2>
  ...
  test("clear button not visible when readOnly=true", async ({
    ...
    await initTestBed(`
      <Select2 clearable="true" readOnly="true" initialValue="opt1">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
      </Select2>
    `);
  ...
  test("clear button not visible when enabled=false", async ({
    ...
    await initTestBed(`
      <Select2 clearable="true" enabled="false" initialValue="opt1">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
      </Select2>
    `);
  ...
  test("clear button triggers didChange event", async ({
    ...
    const { testStateDriver } = await initTestBed(`
      <Select2 clearable="true" onDidChange="testState = 'changed'">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
      </Select2>
    `);
...
test.describe("Label", () => {
  ...
  test('labelWidth applies with labelPosition="start"', async ({ initTestBed, page }) => {
    ...
    await initTestBed(`
      <Select2 label="Dignissimos esse quasi" labelWidth="200px" labelPosition="start" >
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
...
test.describe("searchable select", () => {
  test("placeholder is shown", async ({ initTestBed, page, createSelectDriver }) => {
    await initTestBed(`
      <Select2 searchable placeholder="Please select an item">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
      </Select2>
  ...
  test("inProgressNotificationMessage shown when inProgress is true", async ({
    ...
    await initTestBed(`
      <Select2 searchable inProgress inProgressNotificationMessage="in-progress-msg">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
      </Select2>
  ...
  test("inProgressNotificationMessage not shown when inProgress is false", async ({
    ...
    await initTestBed(`
      <Select2 searchable inProgress="false" inProgressNotificationMessage="in-progress-msg">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
      </Select2>
...
test.describe("multiSelect", () => {
  test("initialValue='{[0]}' works", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Fragment>
        <Select2 id="mySelect" initialValue="{[0]}" multiSelect>
          <Option value="{0}" label="Zero"/>
          <Option value="{1}" label="One"/>
          <Option value="{2}" label="Two"/>
        </Select2>
  ...
  test("initialValue='{[0,1]}' works", { tag: "@smoke" }, async ({ page, initTestBed }) => {
    await initTestBed(`
      <Fragment>
        <Select2 id="mySelect" initialValue="{[0,1]}" multiSelect>
          <Option value="{0}" label="Zero"/>
          <Option value="{1}" label="One"/>
          <Option value="{2}" label="Two"/>
        </Select2>
  ...
  test("select multiple items without closing listbox", async ({
    ...
    const { testStateDriver } = await initTestBed(`
      <Fragment>
        <Select2 id="mySelect" multiSelect>
          <Option value="{0}" label="Zero"/>
          <Option value="{1}" label="One"/>
          <Option value="{2}" label="Two"/>
        </Select2>
  ...
  test(
    ...
    async ({ initTestBed, page, createSelectDriver }) => {
      await initTestBed(`
      <Select2 label="Choose an option" multiSelect>
        <Option value="1" label="One"/>
        <Option value="2" label="Two"/>
      </Select2>
    `);
  ...
  test('labelPosition="start" is left in ltr language', async ({ initTestBed, page }) => {
    await initTestBed(`
      <Select2 multiSelect label="hi there" labelPosition="start" labelBreak="false">
        <Option value="1" label="One"/>
        <Option value="2" label="Two"/>
      </Select2>
      `);
  ...
  test("multiSelect autoFocus brings the focus to component", async ({
    ...
    await initTestBed(`
      ...
      <Select2 testId="focused-select" multmultiSelect autoFocus>
        <Option value="1" label="One"/>
        <Option value="2" label="Two"/>
      </Select2>
    `);
  ...
  test("autoFocus brings the focus to component", async ({
    ...
    await initTestBed(`
      <Select2 initialValue="opt1" placeholder="Select2..." multiSelect>
...
test.describe("searchable multiselect", { tag: "@smoke" }, () => {
  test("searching for and selecting 2 items works", async ({
    ...
    await initTestBed(`
      <Fragment>
        <Select2 id="mySelect" testId="mySelect" multiSelect searchable>
          <Option value="{0}" label="Zero"/>
          <Option value="{1}" label="One"/>
          <Option value="{2}" label="Two"/>
        </Select2>
...
test.describe("Event Handling", () => {
  test("gotFocus event fires on focus", async ({ initTestBed, page }) => {
    const { testStateDriver } = await initTestBed(`
      <Select2 onGotFocus="testState = 'focused'">
        <Option value="1" label="One"/>
        <Option value="2" label="Two"/>
      </Select2>
    `);
  ...
  test("gotFocus event fires on label click", async ({ initTestBed, page }) => {
    const { testStateDriver } = await initTestBed(`
      <Select2 label="Choose" onGotFocus="testState = 'focused'">
        <Option value="1" label="One"/>
        <Option value="2" label="Two"/>
      </Select2>
    `);
  ...
  test("lostFocus event fires on blur", async ({ initTestBed, page }) => {
    const { testStateDriver } = await initTestBed(`
      <Select2 onLostFocus="testState = 'blurred'">
        <Option value="1" label="One"/>
        <Option value="2" label="Two"/>
      </Select2>
    `);
...
test("initialValue honored when used within Form", async ({ initTestBed, page }) => {
  await initTestBed(`
    <Form>
      <Select2 id="mySelect" initialValue="opt3">
        <Option value="opt1" label="first"/>
        <Option value="opt2" label="second"/>
        <Option value="opt3" label="third"/>
      </Select2>
...
test.describe("Visual State", () => {
  test("input has correct width in px", async ({ page, initTestBed }) => {
    await initTestBed(`<Select2 width="200px" testId="test"/>`, {});
  ...
  test("input with label has correct width in px", async ({ page, initTestBed }) => {
    await initTestBed(`<Select2 width="200px" label="test" testId="test"/>`, {});
  ...
  test("input has correct width in %", async ({ page, initTestBed }) => {
    ...
    await initTestBed(`<Select2 width="50%" testId="test"/>`, {});
  ...
  test("input with label has correct width in %", async ({ page, initTestBed }) => {
    await page.setViewportSize({ width: 400, height: 300 });
    await initTestBed(`<Select2 width="50%" label="test" testId="test"/>`, {});
...
test.describe("Z-Index and Modal Layering", () => {
  test("Select2 dropdown in modal is visible and not covered by modal overlay", async ({
    initTestBed,
    page,
    createSelectDriver,
  }) => {
...
test.describe("Theme Variables", () => {
  [
    ...
    test(`applies correct borderRadius ${variant.value}`, async ({ initTestBed, page }) => {
      await initTestBed(`<Select2 testId="test" ${variant.prop} />`, {
...
test.describe("Behaviors and Parts", () => {
  test("handles tooltip", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" tooltip="Tooltip text"><Option value="1" label="Test" /></Select2>`,
    );
  ...
  test("tooltip with markdown content", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" tooltipMarkdown="**Bold text**"><Option value="1" label="Test" /></Select2>`,
    );
  ...
  test("handles variant", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" variant="CustomVariant"><Option value="1" label="Test" /></Select2>`,
      {
        testThemeVars: {
  ...
  test("animation behavior", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" animation="fadeIn"><Option value="1" label="Test" /></Select2>`,
    );
  ...
  test("combined tooltip and animation", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" tooltip="Tooltip text" animation="fadeIn"><Option value="1" label="Test" /></Select2>`,
    );
  ...
  test("can select part: 'listWrapper'", async ({ page, initTestBed }) => {
    await initTestBed(`<Select2 testId="test"><Option value="1" label="Test" /></Select2>`);
  ...
  test("can select part: 'clearButton'", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" clearable="true" initialValue="1"><Option value="1" label="Test" /></Select2>`,
    );
  ...
  test("clearButton part is not present without clearable", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" clearable="false"><Option value="1" label="Test" /></Select2>`,
    );
    const clearButton = page.locator("[data-part-id='clearButton']");
  ...
  test("parts are present when tooltip is added", async ({ page, initTestBed }) => {
    await initTestBed(
      `<Select2 testId="test" tooltip="Tooltip text" clearable="true" initialValue="1"><Option value="1" label="Test" /></Select2>`,
    );
      ...
      <Fragment>
        ...
        <ModalDialog id="outerDialog" title="Outer Dialog">
          <DropdownMenu testId="nested-dropdown" modal="{true}">
            ...
            <Select2 modal="{true}" id="testSelect" testId="testSelect">
