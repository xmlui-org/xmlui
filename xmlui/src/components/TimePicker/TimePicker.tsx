...
export const TimePickerMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`temporaryInvalidBackground-input-${COMP}`]: "rgba(255, 165, 0, 0.15)",
    [`padding-button-${COMP}`]: "4px 6px",
    [`borderRadius-button-${COMP}`]: "$borderRadius",
    [`hoverColor-button-${COMP}`]: "$color-accent-500",
    [`disabledColor-button-${COMP}`]: "$textColor-disabled",
    [`focusOutlineColor-button-${COMP}`]: "$color-accent-500",
    [`focusOutlineWidth-button-${COMP}`]: "2px",
    [`focusOutlineOffset-button-${COMP}`]: "2px",
