...
test.describe("Basic Functionality", () => {
  test("renders with basic data and columns", async ({ initTestBed, page }) => {
    await initTestBed(`
      <TableW data='{${JSON.stringify(sampleData)}}' testId="table">
  ...
  test("invokes onRowDoubleClick when row is double-clicked", async ({ initTestBed, page }) => {
    const { testStateDriver } = await initTestBed(`
      <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onRowDoubleClick="(item) => testState = item.name">
        <Column bindTo="name"/>
  ...
  test.describe("data property", () => {
    test("displays data with different value types", async ({ initTestBed, page }) => {
      ...
      await initTestBed(`
        <TableW data='{${JSON.stringify(mixedData)}}' testId="table">
          <Column bindTo="name"/>
    ...
    test("handles undefined data gracefully", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{undefined}' testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
  ...
  test.describe("items property", () => {
    test("items property works as alias for data", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW items='{${JSON.stringify(sampleData)}}' testId="table">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
  ...
  test.describe("hideHeader property", () => {
    test("hides header when hideHeader is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' hideHeader="true" testId="table">
          <Column bindTo="name" header="Name"/>
          <Column bindTo="quantity" header="Quantity"/>
        </TableW>
      `);
    ...
    test("shows header when hideHeader is false", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' hideHeader="false" testId="table">
          <Column bindTo="name" header="Name"/>
          <Column bindTo="quantity" header="Quantity"/>
        </TableW>
      `);
  ...
  test.describe("noBottomBorder property", () => {
    test("removes bottom border when noBottomBorder is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' noBottomBorder="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
  ...
  test.describe("rowsSelectable property", () => {
    test("enables row selection when rowsSelectable is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
    ...
    test("disables row selection when rowsSelectable is false", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="false" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
    ...
    test("checkbox column maintains width with horizontal scrolling (issue #2790)", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{[{foo: "bar"}]}' rowsSelectable="true" testId="table">
  ...
  test.describe("hideSelectionCheckboxes property", () => {
    test("hides checkboxes when true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="true" enableMultiRowSelection="true" hideSelectionCheckboxes="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
    ...
    test("shows checkboxes when false", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="true" enableMultiRowSelection="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
  ...
  test.describe("alwaysShowSelectionCheckboxes property", () => {
    test("checkboxes are always visible when alwaysShowSelectionCheckboxes is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="true" enableMultiRowSelection="true" alwaysShowSelectionCheckboxes="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
    ...
    test("checkboxes are hidden on non-hovered rows by default (alwaysShowSelectionCheckboxes false)", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="true" enableMultiRowSelection="true" alwaysShowSelectionCheckboxes="false" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
    ...
    test("alwaysShowSelectionCheckboxes has no effect when hideSelectionCheckboxes is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' rowsSelectable="true" enableMultiRowSelection="true" hideSelectionCheckboxes="true" alwaysShowSelectionCheckboxes="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
    ...
    test("alwaysShowSelectionCheckboxes has no effect when row selection is disabled", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' alwaysShowSelectionCheckboxes="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
  ...
  test.describe("autoFocus property", () => {
    test("focuses table when autoFocus is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' autoFocus="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
  ...
  test.describe("checkboxTolerance property", () => {
    test("allows checkbox interaction within compact tolerance boundary", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}'
               rowsSelectable="true"
  ...
  test.describe("noDataTemplate property", () => {
    ...
    test("hides no data view when noDataTemplate is empty string", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{[]}' noDataTemplate="" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
  ...
  test.describe("alwaysShowSortingIndicator property", () => {
    test("shows all sorting indicators when alwaysShowSortingIndicator is true", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' alwaysShowSortingIndicator="true" testId="table">
          <Column bindTo="name" header="Name" canSort="true"/>
    ...
    test("hides sorting indicators by default when alwaysShowSortingIndicator is false", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' alwaysShowSortingIndicator="false" testId="table">
          <Column bindTo="name" header="Name" canSort="true"/>
          <Column bindTo="quantity" header="Quantity" canSort="true"/>
        </TableW>
      `);
  ...
  test.describe("onContextMenu event", () => {
    test("fires onContextMenu event on right-click", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = 'context-menu-fired'">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
    ...
    test("provides $item context variable with row data", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = $item">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
    ...
    test("provides $row context variable with row data", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = $row">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
    ...
    test("provides $rowIndex context variable with correct index", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = $rowIndex">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
    ...
    test("provides $itemIndex context variable with correct index", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = $itemIndex">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
    ...
    test("provides all context variables together", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = { item: $item.name, row: $row.name, rowIndex: $rowIndex, itemIndex: $itemIndex }">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
    ...
    test("context variables match the correct row when clicking different rows", async ({ initTestBed, page }) => {
      const { testStateDriver } = await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' testId="table" onContextMenu="() => testState = { name: $item.name, index: $rowIndex }">
          <Column bindTo="name"/>
          <Column bindTo="quantity"/>
        </TableW>
      `);
...
test.describe("Features Needing Investigation", () => {
  test("loading property shows loading state",
    async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW loading="true" testId="table">
          <Column bindTo="name"/>
        </TableW>
      `);
...
test.describe("Pagination Features", () => {
  ...
  test.describe("userSelect properties", () => {
    test("userSelectCell controls text selection in cells", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' userSelectCell="none" testId="table">
          <Column bindTo="name" header="Name"/>
          <Column bindTo="quantity" header="Quantity"/>
        </TableW>
      `);
    ...
    test("userSelectRow controls text selection in rows", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' userSelectRow="text" testId="table">
          <Column bindTo="name" header="Name"/>
          <Column bindTo="quantity" header="Quantity"/>
        </TableW>
      `);
    ...
    test("userSelectHeading controls text selection in headings", async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW data='{${JSON.stringify(sampleData)}}' userSelectHeading="text" testId="table">
          <Column bindTo="name" header="Name"/>
          <Column bindTo="quantity" header="Quantity"/>
        </TableW>
      `);
...
test.describe("Edge Cases", () => {
  test("handles no props gracefully", async ({ initTestBed, page }) => {
    await initTestBed(`<TableW testId="table"/>`);
  ...
  test("handles data with missing properties", async ({ initTestBed, page }) => {
    ...
    await initTestBed(`
      <TableW data='{${JSON.stringify(incompleteData)}}' testId="table">
        <Column bindTo="name"/>
        <Column bindTo="quantity"/>
      </TableW>
    `);
  ...
  test("handles deeply nested object properties", async ({ initTestBed, page }) => {
    ...
    await initTestBed(`
      <TableW data='{${JSON.stringify(nestedData)}}' testId="table">
  ...
  test("handles special characters in data", async ({ initTestBed, page }) => {
    ...
    await initTestBed(`
      <TableW data='{${JSON.stringify(specialData)}}' testId="table">
        <Column bindTo="name"/>
  ...
  test("row checkboxes work when data array contains items with 'id' property",
    async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW testId="table" rowsSelectable="true" data="{[
          { id: 1, name: 'Item 1' },
          { id: 2, name: 'Item 2' }
        ]}">
  ...
  test("row checkboxes work when 'idKey' property is specified",
    async ({ initTestBed, page }) => {
      await initTestBed(`
        <TableW testId="table" rowsSelectable="true"
          idKey="account_id"
          data="{[
...
test.describe("Theme Variables and Styling", () => {
  test("applies heading background color theme variable",
    async ({ initTestBed, page }) => {
      ...
      `, {
        testThemeVars: { "backgroundColor-heading-TableW": "rgb(255, 0, 0)" },
      });
...
test.describe("Cell Vertical Alignment", () => {
  ...
  test("applies top alignment when cellVerticalAlign='top'", async ({ initTestBed, page }) => {
    await initTestBed(`
      <TableW data='{${JSON.stringify(sampleData)}}' cellVerticalAlign="top" testId="table">
        <Column bindTo="name" header="Name"/>
        <Column bindTo="quantity" header="Quantity"/>
      </TableW>
    `);
  ...
  test("applies bottom alignment when cellVerticalAlign='bottom'", async ({ initTestBed, page }) => {
    await initTestBed(`
      <TableW data='{${JSON.stringify(sampleData)}}' cellVerticalAlign="bottom" testId="table">
        <Column bindTo="name" header="Name"/>
        <Column bindTo="quantity" header="Quantity"/>
      </TableW>
    `);
  ...
  test("applies center alignment when cellVerticalAlign='center'", async ({ initTestBed, page }) => {
    await initTestBed(`
      <TableW data='{${JSON.stringify(sampleData)}}' cellVerticalAlign="center" testId="table">
        <Column bindTo="name" header="Name"/>
        <Column bindTo="quantity" header="Quantity"/>
      </TableW>
    `);
