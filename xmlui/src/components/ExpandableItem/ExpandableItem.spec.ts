...
test.describe("Basic Functionality", () => {
  ...
  test("component displays summary content correctly", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
  ...
  test("component handles initiallyExpanded prop", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test" initiallyExpanded="true">Content here</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component toggles on summary click", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
  ...
  test("component displays correct icons for collapsed and expanded states", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
  ...
  test("component supports iconPosition prop", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test" iconPosition="start">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component handles withSwitch prop", async ({ initTestBed, createExpandableItemDriver }) => {
    await initTestBed(
      `<ExpandableItem summary="Test" withSwitch="true">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component content has default width of 100% relative to parent", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test" initiallyExpanded="true" testId="test-id-component">
        <Stack backgroundColor="lightgreen">Content</Stack>
      </ExpandableItem>
    </Stack>
  `,
      {},
    ...
    // Get the parent container width and content width
    const parent = page.getByTestId("parent");
    const content = driver.getContent();
    const parentBox = await parent.boundingBox();
    const contentBox = await content.boundingBox();

    // Content should be 100% of parent width
    expect(contentBox.width).toBeCloseTo(parentBox.width, 0);
  });

  test("component accepts custom contentWidth relative to parent", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test" contentWidth="50%" initiallyExpanded="true" testId="test-id-component">
        <Stack backgroundColor="lightgreen">Content</Stack>
      </ExpandableItem>
    </Stack>
  `,
    ...
    // Content should be 50% of parent width
    expect(contentBox.width).toBeCloseTo(parentBox.width * 0.5, 0);
  });

  test("component contentWidth works with pixel values", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test" contentWidth="300px" initiallyExpanded="true" testId="test-id-component">
        <Stack backgroundColor="lightgreen">Content</Stack>
      </ExpandableItem>
    </Stack>
  `,
    ...
    // Content should be exactly 300px
    expect(contentBox.width).toBeCloseTo(300, 0);
  });

  test("component contentWidth works with component definition summary", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem contentWidth="75%" initiallyExpanded="true" testId="test-id-component">
  ...
  `,
    ...
    // Content should be 75% of parent width
    expect(contentBox.width).toBeCloseTo(parentBox.width * 0.75, 0);
  });

  test("summary has default inline width (fullWidthSummary=false)", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test" testId="test-id-component">
        <Text>Content</Text>
      </ExpandableItem>
    </Stack>
  `,
    ...
    // Get the parent and summary widths
    const parent = page.getByTestId("parent");
    const summary = driver.getSummary();
    const parentBox = await parent.boundingBox();
    const summaryBox = await summary.boundingBox();

    // Summary should be narrower than parent (inline-flex behavior)
    expect(summaryBox.width).toBeLessThan(parentBox.width);
  });

  test("fullWidthSummary makes summary take full parent width", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test" fullWidthSummary="true" testId="test-id-component">
        <Text>Content</Text>
      </ExpandableItem>
    </Stack>
  `,
    ...
    // Summary should take full parent width
  ...
  test("fullWidthSummary with iconPosition='end' takes full width", async ({
    ...
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test Summary" fullWidthSummary="true" iconPosition="end" testId="test-id-component">
        <Text>Content</Text>
      </ExpandableItem>
    </Stack>
  `,
    ...
    // Summary should be full width with iconPosition=end
    expect(summaryBox.width).toBeCloseTo(parentBox.width, 0);
  });

  test("fullWidthSummary with iconPosition='start' takes full width", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem summary="Test Summary" fullWidthSummary="true" iconPosition="start" testId="test-id-component">
        <Text>Content</Text>
      </ExpandableItem>
    </Stack>
  `,
    ...
    // Summary should be full width with iconPosition=start
    expect(summaryBox.width).toBeCloseTo(parentBox.width, 0);
  });

  test("fullWidthSummary works with contentWidth property", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  `,
    ...
    // Summary should be full width
    expect(summaryBox.width).toBeCloseTo(parentBox.width, 0);
    // Content should be 50% width
    expect(contentBox.width).toBeCloseTo(parentBox.width * 0.5, 0);
  });

  test("fullWidthSummary works with component definition summary", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `
    <Stack width="400px" testId="parent">
      <ExpandableItem fullWidthSummary="true" testId="test-id-component">
        <property name="summary">
          <Text>Custom Summary</Text>
        </property>
        <Text>Content</Text>
...
test.describe("Accessibility", () => {
  ...
  test("component ARIA attributes update with expansion state", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component content region has correct ARIA attributes", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test Summary" initiallyExpanded="true">Content here</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component is keyboard accessible with Enter key", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    const { testStateDriver } = await initTestBed(
      `<ExpandableItem summary="Test" onExpandedChange="arg => testState = arg">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component is keyboard accessible with Space key", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component maintains focus after keyboard toggle", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component is focusable only when enabled", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test" enabled="false">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component keyboard interaction works with switch variant", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
    const { testStateDriver } = await initTestBed(
      `<ExpandableItem summary="Test" withSwitch="true" onExpandedChange="arg => testState = arg">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component renders with component definition summary", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component definition summary displays correctly with multiple elements", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component definition summary can be toggled", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component definition summary works with events", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component definition summary works with custom icons", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component definition summary works with initiallyExpanded", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component icon/switch container is hidden from screen readers", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component supports screen reader navigation", async ({
    ...
    await initTestBed(
      `<ExpandableItem summary="Accessible Summary">Screen reader content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
...
test.describe("Visual state", () => {
  ...
  test("component applies expanded visual state", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test" initiallyExpanded="true">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component applies withSwitch visual state", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
  ...
  test("component handles icon position styling", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test" iconPosition="end">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
...
test.describe("Edge cases", () => {
  ...
  test("component handles special characters in summary", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
      `<ExpandableItem summary="Test with émojis 🚀 & quotes">Content</ExpandableItem>`,
      {},
    );
    const driver = await createExpandableItemDriver();
  ...
  test("component handles complex summary content", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
  ...
  test("component handles disabled state interaction", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
  ...
  test("component works in layout contexts", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
  ...
  test("component event handlers work correctly", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    const { testStateDriver } = await initTestBed(
  ...
  test("component works with switch variant", async ({
    initTestBed,
    createExpandableItemDriver,
    page,
  }) => {
  ...
  test("component works in nested scenarios", async ({
    initTestBed,
    createExpandableItemDriver,
  }) => {
    await initTestBed(
