...
test.describe("Basic Functionality", () => {
  ...
  test("initialValue sets textarea value correctly", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("initialValue accepts different data types", async ({ initTestBed, createTextAreaDriver }) => {
    // Test string
  ...
  test("component handles null and undefined props gracefully", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("readOnly prevents editing but allows focus", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("placeholder shows when textarea is empty", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("placeholder is hidden when textarea has content", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles special characters correctly", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea />`);
    const driver = await createTextAreaDriver();
  ...
  test("component handles very long input values", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles rapid input changes efficiently", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea />`);
    const driver = await createTextAreaDriver();
  ...
  test("component prop changes update display correctly", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("autoSize enables automatic height adjustment", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("Shift+Enter creates new line even with enterSubmits=true", async ({ initTestBed, page }) => {
    const { testStateDriver } = await initTestBed(`
      <Form onSubmit="testState = 'submitted'">
        <TextArea enterSubmits="true" />
      </Form>
  ...
  test("escResets=false does not reset on Escape", async ({ initTestBed, createTextAreaDriver }) => {
...
test.describe("Accessibility", () => {
  test("component has correct accessibility attributes", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea label="Comments" />`);
    const driver = await createTextAreaDriver();
  ...
  test("component is keyboard accessible when interactive", async ({ initTestBed, createTextAreaDriver }) => {
    const { testStateDriver } = await initTestBed(`
      <TextArea 
        label="Comments"
  ...
  test("non-interactive component is not focusable when disabled", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea enabled="false" />`);
    const driver = await createTextAreaDriver();
  ...
  test("component disabled has proper accessibility state", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("placeholder provides accessible description", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component supports multiple textareas with keyboard navigation", async ({ initTestBed, page }) => {
    await initTestBed(`
      <Fragment>
...
test.describe("Visual States", () => {
  test("component applies theme variables correctly", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea />`, {
      testThemeVars: {
  ...
  test("component handles different validation states", async ({ initTestBed, createTextAreaDriver }) => {
    // Test error state
  ...
  test("component transitions smoothly between states", async ({ initTestBed, createTextAreaDriver }) => {
    // Test normal state
    await initTestBed(`<TextArea />`);
    const driver = await createTextAreaDriver();
    await expect(driver.field).toBeVisible();
  ...
  test("component handles different resize options", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles focus and hover states", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea />`);
    const driver = await createTextAreaDriver();
  ...
  test("component handles different visual configurations", async ({ initTestBed, createTextAreaDriver }) => {
...
test.describe("Edge Cases", () => {
  ...
  test("component handles special characters correctly", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea label="José María's Comments" placeholder="Введите текст здесь" />`);
    const driver = await createTextAreaDriver();
    await expect(driver.component).toBeVisible();
  ...
  test("component handles extreme values gracefully", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles invalid resize values gracefully", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`<TextArea resize="invalid" />`);
    const driver = await createTextAreaDriver();
    await expect(driver.component).toBeVisible();
  });

  test("component handles conflicting prop combinations", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles empty and whitespace-only values", async ({ initTestBed, createTextAreaDriver }) => {
    // Empty value
    await initTestBed(`<TextArea initialValue="" />`);
    let driver = await createTextAreaDriver();
    await expect(driver.field).toHaveValue("");
  ...
  test("component handles edge cases with autoSize properties", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles conflicting enterSubmits and escResets", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles autoSize with resize options", async ({ initTestBed, createTextAreaDriver }) => {
...
test.describe("Performance", () => {
  test("component memoization prevents unnecessary re-renders", async ({ initTestBed, createTextAreaDriver }) => {
    const { testStateDriver } = await initTestBed(`
      <TextArea 
  ...
  test("component handles rapid prop changes efficiently", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles large content efficiently", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component performs well with rapid user input", async ({ initTestBed, createTextAreaDriver }) => {
    const { testStateDriver } = await initTestBed(`
...
test.describe("Integration", () => {
  test("component works correctly in different layout contexts", async ({ initTestBed, createTextAreaDriver }) => {
  ...
  test("component handles complex validation scenarios", async ({ initTestBed, createTextAreaDriver }) => {
    await initTestBed(`
      <TextArea 
        required="true"
        maxLength="100"
