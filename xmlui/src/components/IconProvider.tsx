...
registerIconRenderer("chevronsright", (props: IconBaseProps) => <ChevronsRightIcon {...props} />);
registerIconRenderer("chevronsleft", (props: IconBaseProps) => <ChevronsLeftIcon {...props} />);
