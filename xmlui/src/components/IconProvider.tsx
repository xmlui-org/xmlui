  ...
  useMemo(() => {
    ...
    Object.entries(icons).forEach(([iconName, svgData]) => {
      ...
      registerIconRenderer(iconKey, (props: IconBaseProps) => {
        ...
        const mergedAttributeMap = mergedAttributes as Record<string, unknown>;
        Object.keys(mergedAttributeMap).forEach(key => {
          if (mergedAttributeMap[key] === undefined) {
            delete mergedAttributeMap[key];
          }
        });
