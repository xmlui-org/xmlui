...
export const ButtonMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`outlineColor-${COMP}-primary-solid--focus`]: "$color-primary-300",
    [`outlineColor-${COMP}-secondary-solid--focus`]: "$color-primary-300",
    [`outlineColor-${COMP}-attention-solid--focus`]: "$color-primary-300",
