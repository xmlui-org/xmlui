...
export const TreeDisplay = memo(forwardRef(function TreeDisplay(
  { style, className, classes, children, content = defaultProps.content, itemHeight = defaultProps.itemHeight, onContextMenu, ...rest }: Props,
  ...
  return (
    <div {...rest} className={classnames(styles.treeDisplay, classes?.[COMPONENT_PART_KEY], className)} style={style} ref={forwardedRef} onContextMenu={onContextMenu}>
