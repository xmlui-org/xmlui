...
test("component renders with menu items", async ({
  initTestBed,
...
test("component opens and closes menu correctly", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component handles menu item clicks", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component handles different alignment options", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component supports submenu functionality", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component supports menu separators", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("disabled component is not keyboard accessible", async ({
  initTestBed,
  createDropdownMenuDriver,
}) => {
...
test("component applies different trigger button variants", async ({
  initTestBed,
  createDropdownMenuDriver,
}) => {
...
test("component applies different trigger button theme colors", async ({
  initTestBed,
  createDropdownMenuDriver,
}) => {
  // Test primary theme
...
test("component displays trigger button icon correctly", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component handles icon position correctly", async ({
  initTestBed,
  createDropdownMenuDriver,
}) => {
  // Test icon at end (default)
  await initTestBed(
    `<DropdownMenu label="Menu" triggerButtonIcon="test" triggerButtonIconPosition="end" />`,
    {
      resources: {
        "icon.test": "resources/bell.svg",
      },
  ...
  // Test icon at start
  await initTestBed(
    `<DropdownMenu label="Menu" triggerButtonIcon="test" triggerButtonIconPosition="start" />`,
    {
      resources: {
        "icon.test": "resources/bell.svg",
      },
...
test("component handles special characters in labels", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component handles empty menu gracefully", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component handles very long labels", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
  const longLabel =
    "This is a very long label that might cause issues with component rendering or layout. It contains many words and should test how the component handles text overflow and wrapping scenarios.";
...
test("component handles disabled menu items", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component supports custom trigger template", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component handles onWillOpen event correctly", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component prevents opening when onWillOpen returns false", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component API methods work correctly", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
...
test("component works with nested menu structures", async ({
  initTestBed,
  createDropdownMenuDriver,
  page,
}) => {
