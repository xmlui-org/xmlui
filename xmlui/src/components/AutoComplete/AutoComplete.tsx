...
export const AutoCompleteMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`fontSize-badge-${COMP}`]: "$fontSize-sm",
    [`paddingHorizontal-badge-${COMP}`]: "$space-2_5",
    [`paddingVertical-badge-${COMP}`]: "$space-0_5",
    [`borderRadius-badge-${COMP}`]: "$borderRadius",
    ...
    [`textColor-badge-${COMP}`]: "$const-color-surface-50",
