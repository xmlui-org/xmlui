...
async function verifyAppContainerScrollable(page: Page, shouldBeScrollable: boolean) {
  const info = await page.evaluate(() => {
    ...
    const mainContentArea = appWrapper.querySelector('[class*="mainContentArea"], [class*="contentWrapper"]');
...
async function scrollAppContainerTo(page: Page, position: "top" | "mid" | "bottom") {
  await page.evaluate((pos) => {
    ...
    // Check if there's a mainContentArea inside (vertical layout)
    const mainContentArea = appWrapper.querySelector('[class*="mainContentArea"], [class*="contentWrapper"]') as HTMLElement;
...
test.describe("Desktop Layout - with Header and Footer", () => {
  ...
  test("header and footer are sticky when content is tall", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
  ...
  test("main content is the scroll container", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
  ...
  test("no scrollbar gutters in desktop layout", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
  ...
  test("container stretches to full viewport (100vw × 100vh)", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
...
test.describe("Desktop Layout - without Header and Footer", () => {
  ...
  test("main content fills entire viewport", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
  ...
  test("tall content scrolls within main content area", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
...
test.describe("Desktop Layout - scrollWholePage and noScrollbarGutters props", () => {
  ...
  test("scrollWholePage prop is ignored in desktop layout", async ({
    initTestBed,
    page,
  }) => {
  ...
  test("noScrollbarGutters prop is ignored in desktop layout", async ({
    initTestBed,
    page,
  }) => {
...
test.describe("Desktop Layout - NavPanel behavior", () => {
  ...
  test("NavPanel is not rendered even when provided", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
  ...
  test("no drawer/hamburger menu in desktop layout", async ({
    initTestBed,
    page,
  }) => {
    await initTestBed(`
