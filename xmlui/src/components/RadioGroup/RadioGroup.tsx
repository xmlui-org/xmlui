...
export const RadioGroupMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`color-bg-checked-${RGOption}--disabled]`]: `$borderColor-${RGOption}--disabled`,
    [`color-bg-checked-${RGOption}-error`]: `$borderColor-${RGOption}-error`,
    [`color-bg-checked-${RGOption}-warning`]: `$borderColor-${RGOption}-warning`,
    [`color-bg-checked-${RGOption}-success`]: `$borderColor-${RGOption}-success`,
    [`fontSize-${RGOption}`]: "$fontSize-small",
    [`fontWeight-${RGOption}`]: "$fontWeight-bold",
    [`color-text-${RGOption}-error`]: `$borderColor-${RGOption}-error`,
    [`color-text-${RGOption}-warning`]: `$borderColor-${RGOption}-warning`,
    [`color-text-${RGOption}-success`]: `$borderColor-${RGOption}-success`,
    light: {
