...
export const CarouselMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`backgroundColor-control-${COMP}--hover`]: "$color-primary",
    [`textColor-control-${COMP}--hover`]: "$textColor",
    [`backgroundColor-control-${COMP}--active`]: "$color-primary",
    [`backgroundColor-control-${COMP}--disabled`]: "$color-surface-200",
    [`textColor-control-${COMP}--disabled`]: "$textColor-disabled",
    [`textColor-control-${COMP}--active`]: "$color-primary",
    [`backgroundColor-indicator-${COMP}`]: "$color-surface-200",
    [`backgroundColor-indicator-${COMP}--active`]: "$color-primary",
    [`textColor-indicator-${COMP}`]: "$color-primary",
    [`textColor-indicator-${COMP}--active`]: "$color-primary",
    [`backgroundColor-indicator-${COMP}--hover`]: "$color-surface-200",
    [`textColor-indicator-${COMP}--hover`]: "$color-primary",
