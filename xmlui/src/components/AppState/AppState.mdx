...
```xmlui-pg name="Example: AppState" height="200px"
---app display copy filename="Main.xmlui"
...
---comp display copy filename="Component1.xmlui"
...
---comp display copy filename="Component2.xmlui"
