...
test.describe("Theme Variables", () => {
  ...
  test.skip("component applies custom thickness theme variable", async ({ page, initTestBed }) => {
    await initTestBed(`<Spinner delay="0" />`, {
      themes: {
...
test.describe("Edge Cases - FullScreen Props", () => {
  ...
  test("component handles mixed boolean case fullScreen values", async ({ page, initTestBed }) => {
    await initTestBed(`<Spinner fullScreen="True" delay="0" />`);
