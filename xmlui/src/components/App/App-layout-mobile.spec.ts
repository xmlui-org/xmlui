...
test.describe("Horizontal Layout Mobile - scrollWholePage=true, noScrollbarGutters=true", () => {
  ...
  test("hamburger menu opens drawer with nav panel", async ({ initTestBed, page }) => {
    await initTestBed(createLayoutMarkup("horizontal", true, true, "200px"));
...
test.describe("Horizontal-Sticky Layout Mobile - scrollWholePage=true, noScrollbarGutters=true", () => {
  ...
  test("tall content at bottom: header and footer remain sticky", async ({ initTestBed, page }) => {
    await initTestBed(createLayoutMarkup("horizontal-sticky", true, true, "2000px"));
...
test.describe("Condensed Layout Mobile - scrollWholePage=false, noScrollbarGutters=true", () => {
  ...
  test("tall content at mid-scroll: only main content scrolls", async ({ initTestBed, page }) => {
    await initTestBed(createLayoutMarkup("condensed", true, false, "2000px"));
  ...
  test("tall content at bottom: only main content scrolls", async ({ initTestBed, page }) => {
    await initTestBed(createLayoutMarkup("condensed", true, false, "2000px"));
...
test.describe("Condensed-Sticky Layout Mobile - scrollWholePage=true, noScrollbarGutters=false", () => {
  ...
  test("short content: all blocks visible, gutters reserved", async ({ initTestBed, page }) => {
...
// =============================================================================
// MOBILE LAYOUT TESTS - VERTICAL-FULL-HEADER
// =============================================================================
// Note: Vertical-full-header layout has a full-width header with sticky positioning.
// Header and footer remain fixed in viewport while main content scrolls.

test.describe("Vertical-Full-Header Layout Mobile - scrollWholePage=true, noScrollbarGutters=true", () => {
  test.beforeEach(async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 667 });
  });
...
test.describe("Vertical-Full-Header Layout Mobile - scrollWholePage=true, noScrollbarGutters=false", () => {
  test.beforeEach(async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 667 });
  });
...
test.describe("Vertical-Full-Header Layout Mobile - scrollWholePage=false, noScrollbarGutters=true", () => {
  test.beforeEach(async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 667 });
  });
...
test.describe("Vertical-Full-Header Layout Mobile - scrollWholePage=false, noScrollbarGutters=false", () => {
  test.beforeEach(async ({ page }) => {
    await page.setViewportSize({ width: 375, height: 667 });
  });
...
test.describe("Desktop Layout Mobile - scrollWholePage=true, noScrollbarGutters=false", () => {
  ...
  test("short content: all blocks visible, no scrollbar", async ({ initTestBed, page }) => {
...
test.describe("Desktop Layout Mobile - scrollWholePage=false, noScrollbarGutters=false", () => {
  ...
  test("short content: main content is scroll container", async ({ initTestBed, page }) => {
