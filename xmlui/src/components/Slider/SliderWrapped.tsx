...
// Metadata is identical — wrapComponent doesn't change how you describe the component
...
export const sliderWrappedComponentRenderer = wrapCompound("SliderW", SliderRender, SliderMd, {
