...
test.describe("Behaviors and Parts", () => {
  ...
  test("requiredIndicator='required' shows asterisk for required fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <Switch testId="test" label="Enable Notifications" required="true" requiredIndicator="required" bindTo="notifications" />
      </Form>
    `);
  ...
  test("requiredIndicator='required' hides indicator for optional fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <Switch testId="test" label="Enable Notifications" required="false" requiredIndicator="required" bindTo="notifications" />
      </Form>
    `);
  ...
  test("requiredIndicator='optional' shows optional tag for optional fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <Switch testId="test" label="Enable Notifications" required="false" requiredIndicator="optional" bindTo="notifications" />
      </Form>
    `);
  ...
  test("requiredIndicator='optional' hides indicator for required fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <Switch testId="test" label="Enable Notifications" required="true" requiredIndicator="optional" bindTo="notifications" />
      </Form>
    `);
  ...
  test("requiredIndicator='both' shows asterisk for required fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <Switch testId="test" label="Enable Notifications" required="true" requiredIndicator="both" bindTo="notifications" />
      </Form>
    `);
  ...
  test("requiredIndicator='both' shows optional tag for optional fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <Switch testId="test" label="Enable Notifications" required="false" requiredIndicator="both" bindTo="notifications" />
      </Form>
    `);
