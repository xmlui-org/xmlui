...
export const SwitchMd = createMetadata({
  ...
  defaultThemeVars: {
    ...
    [`color-bg-checked-${COMP}-error`]: `$borderColor-${COMP}-error`,
    [`borderColor-checked-${COMP}-warning`]: `$borderColor-${COMP}-warning`,
    [`color-bg-checked-${COMP}-warning`]: `$borderColor-${COMP}-warning`,
    [`borderColor-checked-${COMP}-success`]: `$borderColor-${COMP}-success`,
    [`color-bg-checked-${COMP}-success`]: `$borderColor-${COMP}-success`,
    light: {
