import type { ForwardedRef, HTMLAttributes, MutableRefObject, Ref } from "react";
...
function cx(...values: Array<string | undefined | null | false | Record<string, boolean>>): string {
