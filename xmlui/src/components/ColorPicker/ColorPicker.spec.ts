...
test.describe("Behaviors and Parts", () => {
  test("requiredIndicator='required' shows asterisk for required fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <ColorPicker testId="test" label="Theme Color" required="true" requiredIndicator="required" bindTo="themeColor" />
      </Form>
    `);
  ...
  test("requiredIndicator='required' hides indicator for optional fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <ColorPicker testId="test" label="Theme Color" required="false" requiredIndicator="required" bindTo="themeColor" />
      </Form>
    `);
  ...
  test("requiredIndicator='optional' shows optional tag for optional fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <ColorPicker testId="test" label="Theme Color" required="false" requiredIndicator="optional" bindTo="themeColor" />
      </Form>
    `);
  ...
  test("requiredIndicator='optional' hides indicator for required fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <ColorPicker testId="test" label="Theme Color" required="true" requiredIndicator="optional" bindTo="themeColor" />
      </Form>
    `);
  ...
  test("requiredIndicator='both' shows asterisk for required fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <ColorPicker testId="test" label="Theme Color" required="true" requiredIndicator="both" bindTo="themeColor" />
      </Form>
    `);
  ...
  test("requiredIndicator='both' shows optional tag for optional fields", async ({ page, initTestBed }) => {
    await initTestBed(`
      <Form>
        <ColorPicker testId="test" label="Theme Color" required="false" requiredIndicator="both" bindTo="themeColor" />
      </Form>
    `);
